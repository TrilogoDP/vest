...
// Prop Description
$_['prop_descr'] = 'prop_descr[0]="<p><b>FTP host</b></p><p>The name of the hosting server, the IP address of the hosting server or domain <br> Through a colon, you can specify the FTP port (not required)<br><br> Example with FTP port: <b>exmple.com:21</b></p>";';
