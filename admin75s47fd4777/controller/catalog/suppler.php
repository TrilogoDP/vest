...
class ControllerCatalogSuppler extends Controller { 
	...
	public function getColumnName($table, $name) {
  	...
  	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	public function getBaseForm() {
		...
		$data['start'] = $this->url->link('catalog/suppler/start', 'token=' . $this->session->data['token']. '&form_id=' . $this->request->get['form_id'], true);
 	...
 	private function getList() {
		...
		$results = $this->model_catalog_suppler->createTables();
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . $url, true),
      		'separator' => ' :: '
   		);
	
	$data['cstart'] = $this->url->link('catalog/suppler/cstart', 'token=' . $this->session->data['token'] . $url, true);
	$data['ccontinue'] = $this->url->link('catalog/suppler/ccontinue', 'token=' . $this->session->data['token'] . $url, true);
	$data['cstop'] = $this->url->link('catalog/suppler/cstop', 'token=' . $this->session->data['token'] . $url, true);
	$data['insert'] = $this->url->link('catalog/suppler/insert', 'token=' . $this->session->data['token'] . $url, true);
	$data['delete'] = $this->url->link('catalog/suppler/delete', 'token=' . $this->session->data['token'] . $url, true);	
    	...
    	foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('catalog/suppler/update', 'token=' . $this->session->data['token'] . '&form_id=' . $result['form_id'] . $url, true),
				'load' => $this->url->link('catalog/suppler/load', 'token=' . $this->session->data['token'] . '&form_id=' . $result['form_id'] . $url, true),
				'onoff' => $this->url->link('catalog/suppler/onoff', 'token=' . $this->session->data['token'] . '&form_id=' . $result['form_id'] . $url, true)
			);
		...
		$data['sort_name'] = $this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
  	...
  	private function getForm() {
		...
		if (!isset($this->request->get['form_id'])) {
			$data['action'] = $this->url->link('catalog/suppler/insert', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/suppler/update', 'token=' . $this->session->data['token'] . '&form_id=' . $this->request->get['form_id'] . $url, true);
		}
		
		$data['cancel'] = $this->url->link('catalog/suppler', 'token=' . $this->session->data['token'] . $url, true);
		
		if (!isset($this->request->get['form_id'])) {
			$data['scron'] = $this->url->link('catalog/suppler/scron', 'token=' . $this->session->data['token']. $url, true);
		} else {
			$data['scron'] = $this->url->link('catalog/suppler/scron', 'token=' . $this->session->data['token']. '&form_id=' . $this->request->get['form_id'] . $url, true);
		}
		
		if (isset($this->request->get['form_id'])) {
			$data['base'] = $this->url->link('catalog/suppler/base', 'token=' . $this->session->data['token']. '&form_id=' . $this->request->get['form_id'] . $url, true);
		} else {
			$data['base'] = $this->url->link('catalog/suppler/base', 'token=' . $this->session->data['token']. $url, true);
		}		
    	...
    	foreach ($results as $result) {
			...
			$scron[] = array(
				'text' => $this->language->get('text_edit'),
				'href' => $this->url->link('catalog/suppler/scron', 'token=' . $this->session->data['token'] . '&form_id=' . $result['form_id'] . $url, true)
			);
			
			$base = array();	
			$base[] = array(
				'text' => $this->language->get('text_edit'),
				'href' => $this->url->link('catalog/suppler/base', 'token=' . $this->session->data['token'] . '&form_id=' . $result['form_id'] . $url, true)
			);
		...
		for ($i=$n; $i<$limit+$n; $i++) {
			...
			$action[] = array(
				'text' => $this->language->get('text_edit'),
				'href' => $this->url->link('catalog/suppler/update', 'token=' . $this->session->data['token'] . '&form_id=' . $rows[$i]['form_id'] . $url, true)
			);
		...
		$pagination->limit = 50;
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('catalog/suppler/update', 'token=' . $this->session->data['token'] . '&form_id=' . $id . $url . '&page={page}', true);
