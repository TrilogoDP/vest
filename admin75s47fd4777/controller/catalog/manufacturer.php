...
//quicksave end
			...
			if (isset($this->request->post['hide_manufacturer'])) {
				...
				$data['hide_manufacturer'] = $manufacturer_info['hide_manufacturer'];
				} else {
		...
		if (isset($this->request->post['epicentr_coeff'])) {
			...
			$data['epicentr_coeff'] = $manufacturer_info['epicentr_coeff'];
		} else {
			$data['epicentr_coeff'] = '';
		}
		...
		if (isset($this->request->post['epicentr_country'])) {
			...
			$data['epicentr_country'] = $manufacturer_info['epicentr_country'];
		} else {
