...
class ControllerCatalogSeocms extends Controller {
	...
	public function index() {
        ...
        if (!isset($this->session->data[$this->data['token_name']])) return false;
		...
		if (isset($ascp_settings['review_visual']) && $ascp_settings['review_visual']) {
			...
			if (isset($this->request->get['review_id']) || $this->request->get['route'] == 'catalog/review/add' ) {
				...
				if (isset($this->request->get['review_id'])) {
					$this->data['action'] = $this->url->link('common/seocms/reviewdate_save', $this->data['token_name'].'=' . $this->session->data[$this->data['token_name']] . '&review_id=' . $this->request->get['review_id'] . $url, $url_link_ssl);
				} else {					$this->data['action'] = '';
				}
...
/***************************************/
	...
	private function loadadminmenu() {
		...
		$this->data['url_module'] = $this->url->link('module/blog', $this->data['token_name'].'=' . $this->data[$this->data['token_name']], $url_link_ssl);
		$this->data['url_schemes'] = $this->url->link('module/blog/schemes', $this->data['token_name'].'=' . $this->data[$this->data['token_name']], $url_link_ssl);
		$this->data['url_widgets'] = $this->url->link('module/blog/widgets', $this->data['token_name'].'=' . $this->data[$this->data['token_name']], $url_link_ssl);
        $this->data['url_jetcache'] = $this->url->link('jetcache/jetcache', $this->data['token_name'].'=' . $this->data[$this->data['token_name']], $url_link_ssl);
        $this->data['url_fields'] = $this->url->link('catalog/fields', $this->data['token_name'].'=' . $this->data[$this->data['token_name']], $url_link_ssl);

		$this->data['url_blog'] = $this->url->link( 'catalog/blog', $this->data['token_name'].'=' . $this->data[$this->data['token_name']], $url_link_ssl);
		$this->data['url_record'] = $this->url->link( 'catalog/record', $this->data['token_name'].'=' . $this->data[$this->data['token_name']], $url_link_ssl);
		$this->data['url_comment'] = $this->url->link( 'catalog/comment', $this->data['token_name'].'=' . $this->data[$this->data['token_name']] . '&action=comment', $url_link_ssl);
		$this->data['url_review'] = $this->url->link( 'catalog/comment', $this->data['token_name'].'=' . $this->data[$this->data['token_name']] . '&action=review', $url_link_ssl);
		$this->data['url_modules'] = $this->url->link( 'extension/module', $this->data['token_name'].'=' . $this->data[$this->data['token_name']], $url_link_ssl);
		...
		if (SC_VERSION > 23) {
			$this->template = 'module/blogadmin';
		} else {
 	...
 	public function reviewdate_save() {
		...
		if (isset($ascp_settings['review_visual']) && $ascp_settings['review_visual']) {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateFormReview()) {
				...
				$link = $this->url->link('catalog/review', $this->data['token_name'].'=' . $this->session->data[$this->data['token_name']] . $url);
				$this->redirect($link);
			} else {



				$this->data['link'] = $this->url->link('catalog/review/update', $this->data['token_name'].'=' . $this->session->data[$this->data['token_name']] . '&review_id=' . $this->request->get['review_id'] . $url);
