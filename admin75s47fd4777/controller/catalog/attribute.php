...
$data['btn_copy_name'] = $this->language->get('button_copy_name');
			...
			if (isset($this->request->post['suppler_mappings'])) {
				$data['suppler_mappings'] = $this->request->post['suppler_mappings'];
				} elseif (!empty($attribute_info)) {
				$data['suppler_mappings'] = $attribute_info['suppler_mappings'];
				} else {
				$data['suppler_mappings'] = '';
			}
			...
			if (isset($this->request->post['highlight'])) {
				$data['highlight'] = $this->request->post['highlight'];
				} elseif (!empty($attribute_info)) {
				$data['highlight'] = $attribute_info['highlight'];
				} else {
				$data['highlight'] = 0;
			}
