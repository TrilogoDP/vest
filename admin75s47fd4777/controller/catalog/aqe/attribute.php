...
class ControllerCatalogAqeAttribute extends Controller {
	...
	protected function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($attribute_total) ? (($page - 1) * 100) + 1 : 0, ((($page - 1) * 100) > ($attribute_total - 100)) ? $attribute_total : ((($page - 1) * 100) + 100), $attribute_total, ceil($attribute_total / 100));
