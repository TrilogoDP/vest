...
class ControllerExtensionShippingUkrposhta extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['ukrposhta_min_total_for_free_delivery'])) {
            $data['ukrposhta_min_total_for_free_delivery'] = $this->request->post['ukrposhta_min_total_for_free_delivery'];
        } else {
            $data['ukrposhta_min_total_for_free_delivery'] = $this->config->get('ukrposhta_min_total_for_free_delivery');
        }	
