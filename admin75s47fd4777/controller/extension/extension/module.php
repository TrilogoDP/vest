		...
		if ($files) {
            foreach ($files as $file) {
                ...
                if (!in_array('extension/module/' . $extension, $hiden)) {
					...
					$edit = 'extension/module/';
					if (!is_file((DIR_APPLICATION . 'controller/extension/module/' . $extension . '.php'))){
						$edit = 'module/';
					}
                    ...
                    $data['extensions'][] = array(
                        ...
                        'edit' => $this->url->link($edit . $extension, 'token=' . $this->session->data['token'], true)
                    );
                }
            }
        }
