...
class ControllerExtensionModuleAdminQuickEdit extends Controller {
	...
	private $column_defaults = array(
		'aqe_catalog_products'  => array(
			...
			'model_marketplace'  => array('display' => 1, 'qe_status' => 1, 'editable' => 1, 'index' =>  60, 'align' =>   'text-left', 'type' =>         'qe', 'sort' => 'p.model_marketplace'         , 'rel' => array(),           'filter' => array('show' => 1, 'type' => 0, 'autocomplete' => array('return' => array('label' => 'model', 'value' => 'product_id')))),
			...
			'archive'            => array('display' => 1, 'qe_status' => 1, 'editable' => 1, 'index' => 350, 'align' => 'text-center', 'type' =>  'status_qe', 'sort' => 'p.archive'        , 'rel' => array(),           'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
	...
	private static $language_texts = array(
		...
		'txt_model', 'txt_model_marketplace',  'txt_mpn', 'txt_name', 'txt_newsletter', 'txt_opened', 'txt_option_value', 'txt_order_id', 'txt_orders', 'txt_points', 'txt_postcode',
