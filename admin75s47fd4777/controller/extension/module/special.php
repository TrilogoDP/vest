...
class ControllerExtensionModuleSpecial extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['marketing_special'])) {
			$data['marketing_special'] = $this->request->post['marketing_special'];
		} elseif (!empty($module_info)) {
			$data['marketing_special'] = $module_info['marketing_special'];
		} else {
			$data['marketing_special'] = '';
		}
