	...
	class ControllerExtensionModuleOctProductPreorder extends Controller {
		...
		public function history() {
			...
			foreach ($results as $result) {
				...
				'sms_date_added' => date('Y.m.d', strtotime($result['sms_date_added'])),
				'sms_time_added' => date('H:i:s', strtotime($result['sms_date_added'])),
                'note' => $result['note']
				);
			}
		...
		public function add_request() {
			...
			$data = array(
				'info' => json_encode($this->request->post),
				'telephone' => $this->request->post['telephone'],
				'product_id' => $this->request->post['product_id'],
			);
			
			$this->model_extension_module_oct_product_preorder->addRequest($data);
		...
		public function history_fast() {
			...
			$data['products'] = $this->model_extension_module_oct_product_preorder->getCallArrayNoLimit();
			
			$data['cancel'] = $this->url->link('extension/module/oct_product_preorder/history_standalone', 'token=' . $this->session->data['token'], true);
			
			$data['header']      = $this->load->controller('common/header');
			$data['column_left'] = $this->load->controller('common/column_left');
			$data['footer']      = $this->load->controller('common/footer');
			
			$this->response->setOutput($this->load->view('extension/module/oct_product_preorder_history_fast.tpl', $data));
		}
		
		public function history_standalone() {
			$data = array();
			$this->load->model('extension/module/oct_product_preorder');
			$this->language->load('extension/module/oct_product_preorder');
			...
			$data['history_fast'] = $this->url->link('extension/module/oct_product_preorder/history_fast', 'token=' . $this->session->data['token'], true);
			
			$data['header']      = $this->load->controller('common/header');
			$data['column_left'] = $this->load->controller('common/column_left');
			$data['footer']      = $this->load->controller('common/footer');
			
			$this->response->setOutput($this->load->view('extension/module/oct_product_preorder_history_standalone.tpl', $data));
