<?php
	class ControllerExtensionModuleNeedlessimage extends Controller {
		...
		public function index() {
			...
			$data['action'] = $this->url->link('extension/module/needlessimage', 'token=' . $this->session->data['token'], true);
			$data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=module', true);
			
			$data['action_delete'] = $this->url->link('extension/module/needlessimage/delete', 'token=' . $this->session->data['token'], true);
		...
		private function checkPermission() {
			return $this->user->hasPermission('modify', 'extension/module/needlessimage') ? true : false;
		}
