...
class ControllerExtensionModuleMicrodataPro extends Controller { 
	...
	public function index() {
		...
		$this->data['modules_link'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'], true);
		$this->data['text_module'] = $this->language->get('text_module'); 
		
		$this->data['action'] = $this->url->link('extension/module/microdatapro', 'token=' . $this->session->data['token'], true);
		...
		if($this->microdatapro->opencart_version(0) == 2){
			...
			$this->template = 'extension/module/microdatapro';
			$this->children = array(
				'common/header',
				'common/footer'
			);	
