<?php
	class ControllerSettingSetting extends Controller {
		...
		public function setskudeletedmode(){
			$this->load->model('setting/setting');

			$config_skudeleted_mode = $this->model_setting_setting->getSettingValue('config_skudeleted_mode');

			if ($config_skudeleted_mode == 0){
				$this->model_setting_setting->editSettingValue('config', 'config_skudeleted_mode', 1);
			} else {
				$this->model_setting_setting->editSettingValue('config', 'config_skudeleted_mode', 0);
			}

			if ($this->model_setting_setting->getSettingValue('config_skudeleted_mode')){
				$response = '<i class="fa fa-check"></i> SKU ON';
			} else {
				$response = '<i class="fa fa-exclamation-triangle"></i> SKU OFF';
			}
		...
		public function index() {
			...
			if (isset($this->request->post['config_excluded_tax_class_id'])) {
				$data['config_excluded_tax_class_id'] = $this->request->post['config_excluded_tax_class_id'];
				} else {
				$data['config_excluded_tax_class_id'] = $this->config->get('config_excluded_tax_class_id');
			}
			
			//MISC
			if (isset($this->request->post['config_mobiking_optionCompareAttributesExcludeValueWords'])) {
				$data['config_mobiking_optionCompareAttributesExcludeValueWords'] = $this->request->post['config_mobiking_optionCompareAttributesExcludeValueWords'];
				} else {
				$data['config_mobiking_optionCompareAttributesExcludeValueWords'] = $this->config->get('config_mobiking_optionCompareAttributesExcludeValueWords');
			}
			
			if (isset($this->request->post['config_mobiking_collisionWords'])) {
				$data['config_mobiking_collisionWords'] = $this->request->post['config_mobiking_collisionWords'];
				} else {
				$data['config_mobiking_collisionWords'] = $this->config->get('config_mobiking_collisionWords');
			}
			
			if (isset($this->request->post['config_3310_suffix'])) {
				$data['config_3310_suffix'] = $this->request->post['config_3310_suffix'];
				} else {
				$data['config_3310_suffix'] = $this->config->get('config_3310_suffix');
			}
			
			if (isset($this->request->post['config_mma_option_categories'])) {
				$data['config_mma_option_categories'] = $this->request->post['config_mma_option_categories'];
				} else {
				$data['config_mma_option_categories'] = $this->config->get('config_mma_option_categories');
			}

			if (isset($this->request->post['config_kievdigital_use_all_categories'])) {
				$data['config_kievdigital_use_all_categories'] = $this->request->post['config_kievdigital_use_all_categories'];
				} else {
				$data['config_kievdigital_use_all_categories'] = $this->config->get('config_kievdigital_use_all_categories');
			}
			
			if (isset($this->request->post['config_kievdigital_categories'])) {
				$data['config_kievdigital_categories'] = $this->request->post['config_kievdigital_categories'];
				} else {
				$data['config_kievdigital_categories'] = $this->config->get('config_kievdigital_categories');
			}
			
			if (isset($this->request->post['config_ksmua_categories'])) {
				$data['config_ksmua_categories'] = $this->request->post['config_ksmua_categories'];
				} else {
				$data['config_ksmua_categories'] = $this->config->get('config_ksmua_categories');
			}
			
			if (isset($this->request->post['config_skudeleted_mode'])) {
				$data['config_skudeleted_mode'] = $this->request->post['config_skudeleted_mode'];
				} else {
				$data['config_skudeleted_mode'] = $this->config->get('config_skudeleted_mode');
			}
			...
			if (isset($this->request->post['config_limit_catalog_pc'])) {
				$data['config_limit_catalog_pc'] = $this->request->post['config_limit_catalog_pc'];
				} else {
				$data['config_limit_catalog_pc'] = $this->config->get('config_limit_catalog_pc');
			}

			if (isset($this->request->post['config_limit_catalog_tablet'])) {
				$data['config_limit_catalog_tablet'] = $this->request->post['config_limit_catalog_tablet'];
				} else {
				$data['config_limit_catalog_tablet'] = $this->config->get('config_limit_catalog_tablet');
			}

			if (isset($this->request->post['config_limit_catalog_mobile'])) {
				$data['config_limit_catalog_mobile'] = $this->request->post['config_limit_catalog_mobile'];
				} else {
				$data['config_limit_catalog_mobile'] = $this->config->get('config_limit_catalog_mobile');
			}
			...
			if (isset($this->request->post['config_donotcall_status'])) {
				$data['config_donotcall_status'] = $this->request->post['config_donotcall_status'];
				} elseif ($this->config->get('config_donotcall_status')) {
				$data['config_donotcall_status'] = $this->config->get('config_donotcall_status');
				} else {
				$data['config_donotcall_status'] = array();
			}
			...
			if (isset($this->request->post['config_logo_small'])) {
				$data['config_logo_small'] = $this->request->post['config_logo_small'];
				} else {
				$data['config_logo_small'] = $this->config->get('config_logo_small');
			}
			
			if (isset($this->request->post['config_logo_small']) && is_file(DIR_IMAGE . $this->request->post['config_logo_small'])) {
				$data['logo_small'] = $this->model_tool_image->resize($this->request->post['config_logo_small'], 100, 100);
				} elseif ($this->config->get('config_logo_small') && is_file(DIR_IMAGE . $this->config->get('config_logo_small'))) {
				$data['logo_small'] = $this->model_tool_image->resize($this->config->get('config_logo_small'), 100, 100);
				} else {
				$data['logo_small'] = $this->model_tool_image->resize('no_image.png', 100, 100);
			}
			...
			if (isset($this->request->post['config_pricehistory'])) {
				$data['config_pricehistory'] = $this->request->post['config_pricehistory'];
				} else {
				$data['config_pricehistory'] = $this->config->get('config_pricehistory');
			}
