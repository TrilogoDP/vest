...
class ControllerDesignBanner extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['banners'][] = array(
				...
				'hidefilter'    => ($result['hidefilter'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
	...
	protected function getForm() {
		...
		$data['entry_category'] = $this->language->get('entry_category');//***mf
		...
		if (isset($this->request->post['hidefilter'])) {
			$data['hidefilter'] = $this->request->post['hidefilter'];
		} elseif (!empty($banner_info)) {
			$data['hidefilter'] = $banner_info['hidefilter'];
		} else {
			$data['hidefilter'] = false;
		}
		...
		foreach ($banner_images as $key => $value) {
			foreach ($value as $banner_image) {
				...
				$data['banner_images'][$key][] = array(
					...
					'category_id' => $banner_image['category_id']//***mf
				);
			}
		}
