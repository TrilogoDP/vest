...
class ModelSaleOrder extends Model {
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			'track_no'                => (isset($order_query->row['track_no']) ? $order_query->row['track_no'] : ''),
				...
				'track_no'                => !empty($order_query->row['track_no'])?$order_query->row['track_no']:'',
				...
				'system_num'           	  => $order_query->row['system_num']
			);
		} else {
			return;
		}
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, o.*, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified, o.donotcall FROM `" . DB_PREFIX . "order` o";
