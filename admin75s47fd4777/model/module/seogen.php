...
class ModelModuleSeogen extends Model {
	...
	public function urlifyProductOverwrite($product_id) {
		$seogen = $this->config->get('seogen');

		$seogen['products_overwrite'] = true;
		$seogen['products_meta_title_overwrite'] = true;
		$seogen['products_meta_h1_overwrite'] = true;
		$seogen['products_meta_keyword_overwrite'] = true;
		$seogen['products_meta_description_overwrite'] = true;
		$seogen['products_tag_overwrite'] = true;
