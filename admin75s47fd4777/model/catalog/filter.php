...
class ModelCatalogFilter extends Model {
	public function addFilter($data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "filter_group` SET sort_order = '" . (int)$data['sort_order'] . "', selection = '" . (int)$data['selection'] . "'");
	...
	public function editFilter($filter_group_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "filter_group` SET sort_order = '" . (int)$data['sort_order'] . "', selection = '" . (int)$data['selection'] . "' WHERE filter_group_id = '" . (int)$filter_group_id . "'");
