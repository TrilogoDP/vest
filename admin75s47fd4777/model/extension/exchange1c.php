		...
		public function queryOrders() {
			...
			if (count($orders_export)) {
				...
				foreach ($orders_export as $order_id => $order_status_id) {
					...
					if ($_SERVER['REMOTE_ADDR'] == '37.57.184.228'){
					//	$this->log->printr($simpleCustomInfo);
					}
