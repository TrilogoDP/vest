	...
	**/
	productForm: {
		...
		init: function() {
			...
			this.length = $('select#main_category_id').children("option:selected").val();
			
			setInterval(function() {
				var length = $('select#main_category_id').children("option:selected").val();
		...
		*/
			this.category_id = $('select#main_category_id').children("option:selected").val();
