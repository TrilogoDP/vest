        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#tab_tool_image" data-toggle="tab" id="link_tab_tool_image"><?php echo $tab_tool_image; ?></a>
                    </li>
                    <li>
                        <a href="#tab_tool_backup" data-toggle="tab" id="link_tab_tool_backup"><?php echo $tab_tool_backup; ?></a>
                    </li>
                </ul>
                        ...
                        <div class="row" style="padding-bottom: 20px;">
                            <div class="col-sm-8 col-md-offset-1">
                                <div class="form-group form-group-sm">
                                    <label class="col-sm-5 control-label text-right" data-prop_id="4"><?php echo $text_core_update; ?></label>
                                    <div class="col-sm-7">
                                        <a class="btn btn-info btn-sm" href="<?php echo $update_core; ?>"><?php echo $button_refresh; ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-8 col-md-offset-1">
                                <form action="<?php echo $action; ?>" method="post" id="form_general" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4">
                                            <select name="csvprice_pro_csv_import_mod" class="form-control input-sm">
                                                <?php if ($csvprice_pro_csv_import_mod == 1) { ?>
                                                    <option value="2"><?php echo $text_auto_ajax; ?></option>
                                                    <option value="1" selected="selected"><?php echo $text_manual; ?></option>
                                                <?php } else { ?>
                                                    <option value="2" selected="selected"><?php echo $text_auto_ajax; ?></option>
                                    ...
                                    <div class="form-group form-group-sm">
                                        <label class="col-sm-5 control-label" data-prop_id="5"><?php echo $entry_each_iteration_timeout; ?></label>
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            <div class="input-group input-group-sm">
                                                <input type="text" name="csvprice_pro_each_iteration_timeout" class="form-control input-sm text-right" value="<?php echo $csvprice_pro_each_iteration_timeout; ?>">
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-2">
                                            ...
                                            <div class="control-label pull-left">
                                                <button type="button" class="btn btn-warning btn-sm" onclick="confirm('<?php echo $text_confirm; ?>') ? location.href = '<?php echo $clear; ?>' : false;">
                                                    <i class="fa fa-eraser"></i> <?php echo $button_delete_image_cache; ?>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-8 col-md-offset-1">
                                <form class="form-horizontal form-control-sm">
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <a onclick="confirm('<?php echo $text_confirm; ?>') ? location.href = '<?php echo $cache; ?>' : false;" class="btn btn-warning btn-sm"><i class="fa fa-eraser"></i> <?php echo $button_clear; ?>
                                            </a>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="col-sm-8 col-md-offset-1">
                                <form action="<?php echo $backup; ?>" method="post" name="form_general_backup" id="form_general_backup" enctype="multipart/form-data" class="form-horizontal form-control-sm">
                                    ...
                                    <div class="form-group form-group-sm">
                                        <label class="col-sm-5 control-label">&nbsp;</label>
                                        <div class="col-sm-7">
                                            <button type="submit" form="form_general_backup" class="btn btn-success" style="min-width:120px">
                                                <i class="fa fa-download"></i> <?php echo $button_export; ?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
