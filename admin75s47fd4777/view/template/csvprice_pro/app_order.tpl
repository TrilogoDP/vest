                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_setting">
                            <form action="<?php echo $action; ?>" method="post" id="form_order_setting" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <table class="table table-hover csvpricepro-field_set">
                                            ...
                                            <?php if (isset($fields_set_help[$key])) { ?>
                                                <tr id="row_<?php echo $id; ?>">
                                                    <td>
                                                        <input type="hidden" name="csv_setting[fields_set][<?php echo $key; ?>][status]" value="0"><label class="control-label checkbox-inline"><input id="<?php echo $id; ?>" <?php if ($item['status']) { ?>checked="checked"<?php } ?> type="checkbox" name="csv_setting[fields_set][<?php echo $key; ?>][status]" value="1"> <?php echo $fields_set_help[$key]; ?>
                                                        </label></td>
                                                    <td>
                                                        <input class="form-control input-sm" type="text" name="csv_setting[fields_set][<?php echo $key; ?>][caption]" value="<?php echo $csv_setting['fields_set'][$key]['caption']; ?>">
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            <?php $id++; ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a onclick="$('.csvpricepro-field_set').find(':checkbox').prop('checked', true);initFieldsSet();"><?php echo $text_select_all; ?></a> /
                                        <a onclick="$('.csvpricepro-field_set').find(':checkbox').prop('checked', false);initFieldsSet();"><?php echo $text_unselect_all; ?></a>
                                        <hr>
                            ...
                            <form action="<?php echo $action_export; ?>" method="post" id="form_order_export" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row">
                                    <div class="col-sm-8 col-md-offset-1">
                                        ...
                                        <div class="form-group form-group-sm">
                                            <label class="col-sm-5 control-label"><?php echo $entry_manufacturer; ?></label>
                                            <div class="col-sm-7">
