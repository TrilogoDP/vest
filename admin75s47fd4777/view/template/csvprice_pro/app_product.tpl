    ...
    <div id="content">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#tab_setting" data-toggle="tab" id="link_tab_setting"><?php echo $tab_setting; ?></a>
                        </li>
                        <li><a href="#tab_fields" data-toggle="tab" id="link_tab_fields"><?php echo $tab_fields; ?></a>
                        </li>
                        <li><a href="#tab_export" data-toggle="tab" id="link_tab_export"><?php echo $tab_export; ?></a>
                        </li>
                        <li><a href="#tab_import" data-toggle="tab" id="link_tab_import"><?php echo $tab_import; ?></a>
                        </li>
                        <li><a href="#tab_macros" data-toggle="tab" id="link_tab_macros"><?php echo $tab_macros; ?></a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div id="tab_setting" class="tab-pane active">
                            ...
                            <form action="<?php echo $action; ?>" method="post" id="form_product_setting" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="box-caption alert-info">
                                            ...
                                            <div class="col-sm-7">
                                                <select name="csv_setting[option_type]" class="form-control input-sm">
                                                    <optgroup label="Choose">
                                                        <option value="select"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'select') {
                                                            echo ' selected="selected"';
                                                        } ?>>Select
                                                        </option>
                                                        <option value="radio"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'radio') {
                                                            echo ' selected="selected"';
                                                        } ?>>Radio
                                                        </option>
                                                        <option value="checkbox"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'checkbox') {
                                                            echo ' selected="selected"';
                                                        } ?>>Checkbox
                                                        </option>
                                                        <option value="image"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'image') {
                                                            echo ' selected="selected"';
                                                        } ?>>Image
                                                        </option>
                                                    </optgroup>
                                                    <optgroup label="Input">
                                                        <option value="text"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'text') {
                                                            echo ' selected="selected"';
                                                        } ?>>Text
                                                        </option>
                                                        <option value="textarea"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'textarea') {
                                                            echo ' selected="selected"';
                                                        } ?>>Textarea
                                                        </option>
                                                    </optgroup>
                                                    <optgroup label="File">
                                                        <option value="file"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'file') {
                                                            echo ' selected="selected"';
                                                        } ?>>File
                                                        </option>
                                                    </optgroup>
                                                    <optgroup label="Date">
                                                        <option value="date"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'date') {
                                                            echo ' selected="selected"';
                                                        } ?>>Date
                                                        </option>
                                                        <option value="time"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'time') {
                                                            echo ' selected="selected"';
                                                        } ?>>Time
                                                        </option>
                                                        <option value="datetime"<?php if (isset($csv_setting['option_type']) && $csv_setting['option_type'] == 'datetime') {
                                                            echo ' selected="selected"';
                                                        } ?>>Date &amp; Time
                                                        </option>
                                                    </optgroup>
                        ...
                        <div id="tab_fields" class="tab-pane fade">
                            ...
                            <form action="<?php echo $action; ?>" method="post" id="formProductFieldSetting" enctype="multipart/form-data" class="form-horizontal">
                                <input type="hidden" name="formProductFieldSetting" value="1">
                                <div class="row">
                                    <div class="col-sm-12" style="padding-left:20px;">
                                        <div class="form-inline">
                                            <div class="form-group form-group-sm" style="margin:0">
                                                <label class="control-label" style="padding-right:10px" data-prop_id="35"><?php echo $entry_find_by_column_number; ?></label>
                                                <select name="productFieldNameAsNumber" class="form-control input-sm" style="min-width:120px">
                                                    <?php if (isset($productFieldNameAsNumber) && $productFieldNameAsNumber == 1) { ?>
                                                        <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                                                        <option value="0"><?php echo $text_no; ?></option>
                                                    <?php } else { ?>
                                                        <option value="1"><?php echo $text_yes; ?></option>
                                        ...
                                        <script>
                                            $('select[name=productFieldNameAsNumber]').change(function () {
                                                if ($(this).val() == 1) {
                                                    $('.csv-field-name-number').text('<?php echo $entry_csv_number; ?>');
                                                } else {
                                                    $('.csv-field-name-number').text('<?php echo $entry_csv_name; ?>');
                                                }
                                            });
                                        </script>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <table id="table-product-field" class="table table-hover table-striped table-macros-field">
                                            ...
                                            <tr>
                                                ...
                                                <?php if (isset($productFieldNameAsNumber) and $productFieldNameAsNumber == 1) { ?>
                                                    <th class="csv-field-name-number"><?php echo $entry_csv_number; ?></th>
                                                <?php } else { ?>
                                                    <th class="csv-field-name-number"><?php echo $entry_csv_name; ?></th>
                                                <?php } ?>
                                                <th>&nbsp</th>
                                            </tr>
                                            </thead>
                                            <?php $product_field_row = 0; ?>
                                            <?php if (!empty($productFieldNameSetting)) { ?>
                                                <tbody id="tbody_data">
                                                <?php foreach ($productFieldNameSetting as $field_key => $field_name) { ?>
                                                    <tr id="product-field-row<?php echo $product_field_row; ?>">
                                                        <td class="text-left" width="46%">
                                                            <input type="hidden" name="productFieldNameSetting[<?php echo $field_key; ?>]" value="<?php echo $field_name; ?>"><?php echo $field_key; ?>
                                                        </td>
                                                        <td class="text-left"><?php echo $field_name; ?></td>
                                                        <td class="text-center">
                                                            <a onclick="$('#product-field-row<?php echo $product_field_row; ?>').remove();" data-toggle="tooltip" title="" class="btn btn-danger btn-sm" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a>
                                                        </td>
                                                    </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <select id="product_field_select" class="form-control input-sm">
                                                        <?php foreach ($productFields as $fieldName) { ?>
                                    ...
                                    <div class="col-sm-6">
                                        <table id="table-productAttributeField" class="table table-hover table-striped">
                                            <thead>
                                            <tr>
                                            ...
                                            <?php $productAttributeFieldRow = 0; ?>
                                            <?php if (!empty($productAttributeFieldNameSetting)) { ?>
                                                <tbody>
                                                <?php foreach ($productAttributeFieldNameSetting as $attribute) { ?>
                                                    <tr id="tr-productAttributeField<?php echo $productAttributeFieldRow; ?>">
                                                        <td class="text-left" width="46%">
                                                            <input type="hidden" name="productAttributeFieldNameSetting[<?php echo $attribute['id']; ?>][id]" value="<?php echo $attribute['id']; ?>"><?php echo $attribute['name']; ?>
                                                        </td>
                                                        <td class="text-left">
                                                            <input type="hidden" name="productAttributeFieldNameSetting[<?php echo $attribute['id']; ?>][csv_name]" value="<?php echo $attribute['csv_name']; ?>"><?php echo $attribute['csv_name']; ?>
                                                        </td>
                                                        <td class="text-center">
                                                            <a onclick="$('#tr-productAttributeField<?php echo $productAttributeFieldRow; ?>').remove();" data-toggle="tooltip" title="" class="btn btn-danger btn-sm" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php $productAttributeFieldRow++; ?>
                                                <?php } ?>
                                                </tbody>
                                                <tbody id="tbody-productAttributeField"></tbody>
                                            <?php } else { ?>
                                                <tbody id="tbody-productAttributeField">
                                                <tr>
                                                    <td colspan="3">
                                                        <?php echo $text_no_results; ?>
                                                    </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" name="product_attribute_select" value="" placeholder="autocomplete" id="input-productAttributeSelect" class="form-control input-sm" autocomplete="off">
                                                    <input type="hidden" name="product_attribute_value" value="" id="input-productAttributeValue">
                                                </td>
                                                <td>
                                                    <input type="text" name="product_attribute_csv_name" id="input-product-attribute-csv-name" value="" class="form-control input-sm">
                                                </td>
                                                <td width="50" class="text-center">
                                                    <a onclick="addProductAttributeFieldRow();" data-toggle="tooltip" title="" class="btn btn-success btn-sm" data-original-title="<?php echo $button_insert; ?>"><i class="fa fa-plus-circle"></i></a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-btn">
													<a onclick="addProfile('profile_export');" data-toggle="tooltip" title="" class="btn btn-success btn-sm" data-original-title="<?php echo $button_add; ?>"><i class="fa fa-plus-circle"></i></a>
                            ...
                            <form action="<?php echo $action_export; ?>" method="post" id="form_product_export" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row">
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-7">
                                                <select name="csv_export[csv_delimiter]" class="form-control input-sm">
                                                    ...
                                                    <option value=","<?php if (isset($csv_export['csv_delimiter']) && $csv_export['csv_delimiter'] == ',') { ?> selected="selected"<?php } ?>> ,</option>
                                                    <option value="^"<?php if (isset($csv_export['csv_delimiter']) && $csv_export['csv_delimiter'] == '^') { ?> selected="selected"<?php } ?>> ^</option>
                                                    <option value="Tab"<?php if (isset($csv_export['csv_delimiter']) && $csv_export['csv_delimiter'] == 'Tab') { ?> selected="selected"<?php } ?>> Tab</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <div id="export_category_list" class="container_fa-minus-circle well well-sm" style="height: 100px; overflow: auto;">
                                                    <?php foreach ($csv_export['from_category'] as $category) { ?>
                                                        <div id="category-id<?php echo $category['category_id']; ?>">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <div id="export_manufacturer_list" class="container_fa-minus-circle well well-sm" style="height: 100px; overflow: auto;">
                                                    <?php foreach ($csv_export['from_manufacturer'] as $manufacturer) { ?>
                                                        <div id="manufacturer-id<?php echo $manufacturer['manufacturer_id']; ?>">
                                                            <i class="fa fa-minus-circle"></i> <?php echo $manufacturer['name']; ?>
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-7">
                                                <select name="csv_export[export_related]" class="form-control input-sm">
                                                    <option value="0"<?php if (!isset($csv_export['export_related']) || $csv_export['export_related'] == 0) {
                                                        echo ' selected="selected"';
                                                    } ?>><?php echo $text_disabled;
                                                        $csv_export['export_related'] = '' ?></option>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-sm-7">
                                                    <select name="csv_export[filter_status]" class="form-control input-sm">
                                                        <option value="3"<?php if (isset($csv_export['filter_status']) && $csv_export['filter_status'] == 3) {
                                                            echo ' selected="selected"';
                                                        } ?>>&nbsp;
                                                        </option>
                                                        <option value="1"<?php if (isset($csv_export['filter_status']) && $csv_export['filter_status'] == 1) {
                                                            echo ' selected="selected"';
                                                        } ?>><?php echo $text_enabled; ?></option>
                                                        <option value="0"<?php if (isset($csv_export['filter_status']) && $csv_export['filter_status'] == 0) {
                                                            echo ' selected="selected"';
                                    ...
                                    <div class="col-sm-6">
                                                ...
                                                <tr id="row_<?php echo $field['uid']; ?>">
                                                    <td>
                                                        <label class="control-label" title="<?php echo $fields_set_help[$field['uid']]; ?> <?php echo $field['uid']; ?>">
                                                            <input <?php if (array_key_exists($field['uid'], $csv_export['fields_set'])) { ?> checked="checked" <?php } ?> type="checkbox" id="<?php echo $index; ?>" name="csv_export[fields_set][<?php echo $field['uid']; ?>]" value="1">
                                        ...
                                        <a onclick="$(this).parent().find(':checkbox').prop('checked', true);initFieldsSet()"><?php echo $text_select_all; ?></a> /
                                        <a onclick="$(this).parent().find(':checkbox').prop('checked', false); initFieldsSet();"><?php echo $text_unselect_all; ?></a>
                                    </div>
                                    <!-- END Fields Set Data -->
                                </div>
                            </form>
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-btn">
													<a onclick="addProfile('profile_import');" data-toggle="tooltip" title="" class="btn btn-success btn-sm" data-original-title="<?php echo $button_add; ?>"><i class="fa fa-plus-circle"></i></a>
													<span style="margin-right:57px;"></span>
													</span>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-7">
                                                <select name="csv_import[csv_delimiter]" class="form-control input-sm">
                                                    ...
                                                    <option value=","<?php if ($csv_import['csv_delimiter'] == ',') { ?> selected="selected"<?php } ?>> ,</option>
                                                    <option value="^"<?php if ($csv_import['csv_delimiter'] == '^') { ?> selected="selected"<?php } ?>> ^</option>
                                                    <option value="Tab"<?php if (isset($csv_import['csv_delimiter']) && $csv_export['csv_delimiter'] == 'Tab') { ?> selected="selected"<?php } ?>> Tab</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group form-group-sm">
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-3">
                                                <input class="form-control text-right" type="text" name="csv_import[calc_value_1]" value="<?php if (isset($csv_import['calc_value_1'])) echo $csv_import['calc_value_1']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-3">
                                                <input class="form-control text-right" type="text" name="csv_import[calc_value_2]" value="<?php if (isset($csv_import['calc_value_2'])) echo $csv_import['calc_value_2']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group form-group-sm">
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-7">
                                                <input class="form-control text-right" type="text" name="csv_import[iter_limit]" value="<?php if (isset($csv_import['iter_limit'])) {
                                                    echo $csv_import['iter_limit'];
                                                } else {
                                                    echo '0';
                                                } ?>">
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-7">
                                                <label class="csvpricepro_label_checkbox"><input class="im_checkbox_skip" type="checkbox" value="1" name="csv_import[skip_manufacturer]"<?php if (isset($csv_import['skip_manufacturer']) && $csv_import['skip_manufacturer'] == 1) { ?> checked="checked"<?php } ?>> <?php echo $text_import_skip; ?>
                                                </label>
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-7">
                                                <label class="csvpricepro_label_checkbox"><input class="im_checkbox_skip" type="checkbox" value="1" name="csv_import[skip_import_store]"<?php if (isset($csv_import['skip_import_store']) && $csv_import['skip_import_store'] == 1) { ?> checked="checked"<?php } ?>> <?php echo $text_import_skip; ?>
                                                </label>
                                                <div class="well well-sm" style="height: 100px; overflow: auto;">
                                                    <?php foreach ($stores as $store) { ?>
                                                        <div class="checkbox">
                                        ...
                                        <?php if ($core_type['MAIN_CATEGORY'] == 1) { ?>
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-sm-7">
                                                    <label class="csvpricepro_label_checkbox"><input class="im_checkbox_skip" type="checkbox" value="1" name="csv_import[skip_main_category]"<?php if (isset($csv_import['skip_main_category']) && $csv_import['skip_main_category'] == 1) { ?> checked="checked"<?php } ?>> <?php echo $text_import_skip; ?>
                                                    </label>
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-7">
                                                <label class="csvpricepro_label_checkbox"><input class="im_checkbox_skip" type="checkbox" value="1" name="csv_import[skip_category]"<?php if (isset($csv_import['skip_category']) && $csv_import['skip_category'] == 1) { ?> checked="checked"<?php } ?>> <?php echo $text_import_skip; ?>
                                                </label>
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <label class="csvpricepro_label_checkbox"><input type="checkbox" name="csv_import[exclude_filter]" value="1" <?php if (isset($csv_import['exclude_filter']) && $csv_import['exclude_filter'] == 1) { ?> checked="checked"<?php } ?>><?php echo $entry_import_exclude_filter; ?>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-group-sm">
                                            <label class="col-sm-5 control-label"><?php echo $text_exclude_filter_field; ?></label>
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                        ...
                                        <div class="well well-sm" id="wraper-exclude-field-list">
                                            <style scoped>
                                                #wraper-exclude-field-list .input-sm, #wraper-exclude-field-list .input-group-sm > .form-control, #wraper-exclude-field-list .input-group-sm > .input-group-addon, #wraper-exclude-field-list .input-group-sm > .input-group-btn > .btn {
                                                    padding: 0 6px;
                                                    font-size: 10px;
                                                }

                                                #wraper-exclude-field-list .input-group-sm > .input-group-btn > .btn {
                                                    padding: 0 9px;
                                                    font-size: 11px;
                                                    padding-top: 4px
                                                }
                                            </style>
                                            <div class="form-inline" id="exclude-field-list">
                                                <?php $product_exclude_field_row = 0; ?>
                                                <?php if (isset($csv_import['exclude_field']) && !empty($csv_import['exclude_field'])) { ?>
                                                    <?php foreach ($csv_import['exclude_field'] as $exclude_filed) { ?>
                                                        <div id="product-exclude-field-row<?php echo $product_exclude_field_row; ?>" class="input-group input-group-sm csvprice_pro-exclude-item">
                                                            <input style="width:auto" type="text" name="csv_import[exclude_field][]" readonly class="form-control input-sm" value="<?php echo $exclude_filed; ?>">
                                                            <div class="input-group-btn">
                                                                <a onclick="$('#product-exclude-field-row<?php echo $product_exclude_field_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i></a>
                                                            </div>
                                                        </div>
                                                        <?php $product_exclude_field_row++; ?>
                                                    <?php } ?>
                                                <?php } ?>
                                                <?php if ($product_exclude_field_row == 0) {
                                                    echo '&nbsp;';
                                                } ?>
                                            </div>
                                        </div>
                        ...
                        <div id="tab_macros" class="tab-pane fade">
                            <form action="<?php echo $action; ?>" method="post" id="form_macros" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <?php if (!empty($product_macros)) { ?>
                                        ...
                                        <?php foreach ($product_macros as $fields) { ?>
                                            <tr id="macros-field-row<?php echo $field_row; ?>">
                                                <td class="text-left">
                                                    <input type="hidden" name="product_macros[<?php echo $field_row; ?>][tbl_name]" value="<?php echo $fields['tbl_name']; ?>"/><?php echo $fields['tbl_name']; ?>
                                                </td>
                                                <td class="text-left">
                                                    <input type="hidden" name="product_macros[<?php echo $field_row; ?>][field_name]" value="<?php echo $fields['field_name']; ?>"/><?php echo $fields['field_name']; ?>
                                                </td>
                                                <td class="text-left">
                                                    <input type="hidden" name="product_macros[<?php echo $field_row; ?>][csv_name]" value="<?php echo $fields['csv_name']; ?>"/><?php echo $fields['csv_name']; ?>
                                                </td>
                                                <td class="text-left">
                                                    <input type="hidden" name="product_macros[<?php echo $field_row; ?>][csv_caption]" value="<?php echo $fields['csv_caption']; ?>"/><?php echo $fields['csv_caption']; ?>
                                                </td>
                                                <td class="text-left">
                                                    <input type="hidden" name="product_macros[<?php echo $field_row; ?>][field_type]" value="<?php echo isset($fields['field_type']) ? $fields['field_type'] : 'HTML'; ?>"/><?php echo isset($fields['field_type']) ? $fields['field_type'] : 'HTML'; ?>
                                                </td>
                                                <td class="text-center">
                                                    <a onclick="$('#macros-field-row<?php echo $field_row; ?>').remove();" data-toggle="tooltip" title="" class="btn btn-danger btn-sm" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a>
                                                </td>
                                            </tr>
                                            <?php $field_row++; ?>
                                        <?php } ?>
                                ...
                                <?php if (isset($text_macro_field_type)) { ?>
                                    <p class="help-block"><?php echo $text_macro_field_type; ?></p>
                                <?php } ?>
                            </form>
                            <div class="row">
                                <div class="col-sm-12">
        ...
        <script>
            ...
            function addProductFieldRow() {
                ...
                if (field_name == '' || $('input[name="productFieldNameSetting[' + field_key + ']"]').length > 0) {
                    return;
                }
                var html = '<tr id="product-field-row' + product_field_row + '">';
                html += '    <td class="text-left"><input type="hidden" name="productFieldNameSetting[' + field_key + ']" value="' + field_name + '" size="1">' + field_key + '</td>';
            ...
            function addProfile(key) {
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        if (json.id) {
                            $('#' + key + '_name').val('');
                            var l = '<?php echo $action; ?>&profile_type=' + key + '&profile_id=' + json['id'];
            ...
            function updateProfile(key) {
                ...
                if (key == 'profile_import') {
                    ...
                    data = $("#form_profile_fields, #formProductFieldSetting").serialize();
                } else {
                    return false;
                }
                $.ajax({
            ...
            function processingImport(p, f = 0) {
                $.ajax({
                    type: 'POST',
            ...
            function addProductExcludeFieldRow() {
                ...
                html += '<input style="width:auto" type="text" name="csv_import[exclude_field][]" readonly class="form-control input-sm" value="' + field + '">';
                ...
                if (product_exclude_field_row < 1) {
                    $('#exclude-field-list').html('');
                }
                $('#exclude-field-list').append(html);
                product_exclude_field_row++;
            }

            // CSV Attribute Custom Field
            var productAttributeFieldRow = <?php echo $productAttributeFieldRow ? $productAttributeFieldRow : 0; ?>;
            $('#input-productAttributeSelect').autocomplete({
                'source': function (request, response) {
                    $.ajax({
                ...
                'select': function (item) {
                    $('#input-productAttributeSelect').val(item['category'] + ': ' + item['label']);
                    $('#input-productAttributeValue').val(item['value']);
                }
            });

            function addProductAttributeFieldRow() {
                var attribute_name = $('#input-productAttributeSelect').val(),
                    attribute_id = $('#input-productAttributeValue').val(),
                    csv_name = $('#input-product-attribute-csv-name').val();
                if (csv_name == '' || attribute_id <= 0) return;
                var html = '<tr id="tr-productAttributeField' + productAttributeFieldRow + '">';
                html += '<td class="text-left" width="46%"><input type="hidden" name="productAttributeFieldNameSetting[' + attribute_id + '][id]" value="' + attribute_id + '">' + attribute_name + '</td>';
                html += '<td class="text-left"><input type="hidden" name="productAttributeFieldNameSetting[' + attribute_id + '][csv_name]" value="' + csv_name + '">' + csv_name + '</td>';
                html += '<td class="text-center"><a onclick="$(\'#tr-productAttributeField' + productAttributeFieldRow + '\').remove();" data-toggle="tooltip" title="" class="btn btn-danger btn-sm" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a>';
                html += '</tr>';
                if (productAttributeFieldRow < 1) $('#table-productAttributeField #tbody-productAttributeField').html('');
                $('#table-productAttributeField #tbody-productAttributeField').append(html);
                $('#input-productAttributeSelect').val('');
                $('#input-productAttributeValue').val(0);
                $('#input-product-attribute-csv-name').val('');
                productAttributeFieldRow++;
            }
