        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#tab_export" data-toggle="tab" id="link_tab_export"><?php echo $tab_export; ?></a></li>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <select name="csv_export[csv_delimiter]" class="form-control">
                                                <option value=";"<?php if ($csv_export['csv_delimiter'] == ';') {
                                                ...
                                                <option value="Tab"<?php if ($csv_export['csv_delimiter'] == 'Tab') {
                                                    echo ' selected="selected"';
                                                } ?>> Tab
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="csv_import[csv_delimiter]" class="form-control">
                                                ...
                                                <option value=","<?php if ($csv_import['csv_delimiter'] == ',') { ?> selected="selected"<?php } ?>> ,</option>
                                                <option value="Tab"<?php if ($csv_import['csv_delimiter'] == 'Tab') { ?> selected="selected"<?php } ?>> Tab</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-sm">
                                ...
                                <?php if (!empty($category_macros)) { ?>
                                    ...
                                    <?php foreach ($category_macros as $fields) { ?>
                                        <tr id="custom-fields-row<?php echo $field_row; ?>">
                                            <td class="text-left">
                                                <input type="hidden" name="category_macros[<?php echo $field_row; ?>][tbl_name]" value="<?php echo $fields['tbl_name']; ?>"/><?php echo $fields['tbl_name']; ?>
                                            </td>
                                            <td class="text-left">
                                                <input type="hidden" name="category_macros[<?php echo $field_row; ?>][field_name]" value="<?php echo $fields['field_name']; ?>"/><?php echo $fields['field_name']; ?>
                                            </td>
                                            <td class="text-left">
                                                <input type="hidden" name="category_macros[<?php echo $field_row; ?>][csv_name]" value="<?php echo $fields['csv_name']; ?>"/><?php echo $fields['csv_name']; ?>
                                            </td>
                                            <td class="text-left">
                                                <input type="hidden" name="category_macros[<?php echo $field_row; ?>][csv_caption]" value="<?php echo $fields['csv_caption']; ?>"/><?php echo $fields['csv_caption']; ?>
                                            </td>
                                            <td class="text-left">
                                                <input type="hidden" name="category_macros[<?php echo $field_row; ?>][field_type]" value="<?php echo isset($fields['field_type']) ? $fields['field_type'] : 'HTML'; ?>"/><?php echo isset($fields['field_type']) ? $fields['field_type'] : 'HTML'; ?>
                                            </td>
                                            <td class="text-center">
                                                <a onclick="$('#custom-fields-row<?php echo $field_row; ?>').remove();" data-toggle="tooltip" title="" class="btn btn-danger btn-sm" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></a>
                                            </td>
                                        </tr>
                                        <?php $field_row++; ?>
                                    <?php } ?>
