                            ...
                            <div class="col-sm-8 col-md-offset-1">
                                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
                                        ...
                                        <div class="col-sm-7">
                                            <select id="job_type" name="job_type" class="form-control">
                                                <?php if ($job['job_type'] == 'import') { ?>
                                                    <option value="import" selected="selected"><?php echo $text_import; ?></option>
                                                    <option value="export"><?php echo $text_export; ?></option>
                                                <?php } else { ?>
                                                    <option value="import"><?php echo $text_import; ?></option>
                                                    <option value="export" selected="selected"><?php echo $text_export; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group input-group-sm" style="max-width:160px;margin-top:10px">
                                                ...
                                                <span class="input-group-addon" style="min-width:80px"><?php echo $text_hours; ?></span>
                                            </div>
                                            <div class="input-group input-group-sm" style="max-width:160px;margin-top:10px">
                                                ...
                                                <span class="input-group-addon" style="min-width:80px"><?php echo $text_minutes; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-sm">
                            ...
                            <?php if ($cron_description) { ?>
                                <div class="pull-left">
                                    <button type="button" id="btn-description" onclick="$('#cron-description').toggle('fast', fnToggleDescription)" class="btn btn-warning btn-sm">
                                        <i class="fa fa-file-text"></i> &nbsp; <?php echo $button_show_description; ?></button>
                                </div>
                            <?php } ?>
                            <div class="pull-right">
                                <button type="button" onclick="location.replace('<?php echo $add; ?>')" class="btn btn-primary btn-sm"> <?php echo $button_add; ?> </button>
                                <button type="button" class="btn btn-danger btn-sm" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form').submit() : false;"> <?php echo $button_delete; ?> </button>
                            </div>
                            <script>
                                function fnToggleDescription() {
                                    if ($('#cron-description').is(':visible')) {
                                        $('#btn-description').html('<i class="fa fa-file-text"></i> &nbsp; <?php echo $button_hide_description; ?>').removeClass('btn-warning').addClass('btn-info');
                                    } else {
                                        $('#btn-description').html('<i class="fa fa-file-text"></i> &nbsp; <?php echo $button_show_description; ?>').removeClass('btn-info').addClass('btn-warning');
                                    }
                                }
                            </script>
                                        ...
                                        <tr id="job-view_<?php echo $job['job_id']; ?>" style="display: none">
                                            <td class="text-left" colspan="9">
                                                <?php if (isset($job['cron_cli']) && !empty($job['cron_cli'])) { ?>
                                                    <p><b>cli cron job command:</b><br/><?php echo $job['cron_cli']; ?>
                                                    </p>
                                                <?php } ?>
                                                <?php if (isset($job['cron_wget']) && !empty($job['cron_wget'])) { ?>
                                                    <p>
                                                        <b>wget cron job command:</b><br/><?php echo $job['cron_wget']; ?>
                                                    </p>
                                                <?php } ?>
                                                <?php if (isset($job['cron_curl']) && !empty($job['cron_curl'])) { ?>
                                                    <p>
                                                        <b>curl cron job command:</b><br/><?php echo $job['cron_curl']; ?>
                                                    </p>
                                                <?php } ?>
                                            </td>
                                        </tr>
