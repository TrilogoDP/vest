    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <?php if (isset($oct_advanced_options_settings_data['status']) && $oct_advanced_options_settings_data['status']) { ?>
          ...
          <?php } ?>
          <?php if (($oct_advanced_options_settings_data['allow_sku'] && $option['sku']) || ($oct_advanced_options_settings_data['allow_model'] && $option['model']) || ($oct_advanced_options_settings_data['allow_ean'] && $option['ean'])) { ?>(<?php if ($oct_advanced_options_settings_data['allow_sku'] && $option['sku']) { ?><?php echo $text_oct_option_sku; ?>: <?php echo $option['sku']; ?>, <?php } ?><?php if ($oct_advanced_options_settings_data['allow_ean'] && $option['ean']) { ?><?php echo $text_oct_option_ean; ?>: <?php echo $option['ean']; ?>, <?php } ?><?php if ($oct_advanced_options_settings_data['allow_model'] && $option['model']) { ?><?php echo $text_oct_option_model; ?>: <?php echo $option['model']; ?><?php } ?>)
          <?php } ?>
          </small>
        <?php } else { ?>
