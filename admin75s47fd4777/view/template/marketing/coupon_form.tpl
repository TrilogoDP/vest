					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-general">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-discount_type">Вид скидки</label>
								<div class="col-sm-10">
									<input type="text" name="discount_type" value="<?php echo $discount_type; ?>" id="input-discount_type" class="form-control" />
									<span class="help text-info"><i class="fa fa-exclamation-circle"></i> не трогать, для подмены правил для автоматически сгенерированных купонов<br />для отзыва после покупки используй код <kbd>afp_discount</kbd></span>
								</div>
							</div>
							<div class="form-group">
