<nav id="column-left">
  <div id="profile">
    ...
    <div>
      ...
      <?php if ($_SERVER['SERVER_ADDR'] == '168.119.125.230') { ?>
        <span class="label label-danger">DEV SERVER</span><br />
      <?php } else { ?>	     
          <span class="label label-success">PRODUCTION</span><br />
      <?php } ?>
  ...
  <ul id="menu">
    ...
    <?php } ?>
			    ...
			    <li><a href="<?php echo $epicentr_xml; ?>"><i class="fa fa-caret-square-o-down"></i> <span>Epicentr XML Export</span></a></li>
