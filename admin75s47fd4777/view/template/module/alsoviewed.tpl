       ...
       <?php if ($error_warning) { ?>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i>&nbsp;<span style="vertical-align:middle;font-weight:bold;">Статистика</span></h3>
                    ...
                    <div class="tabbable">
                        <div class="tab-navigation form-inline">
                            <ul class="nav nav-tabs mainMenuTabs" id="mainTabs">
                                <li><a href="#control_panel" data-toggle="tab"><i class="fa fa-power-off"></i>&nbsp;Панель</a></li>
                                <li id="mainSettingsTab"><a href="#main_statistics" data-toggle="tab"><i class="fa fa-random"></i>&nbsp; Просмотренные пары</a></li>                             
                            </ul>
						...
						?>
                            ...
                            <div id="isense_support" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/module/alsoviewed/tab_support.php'); ?></div>
                        </div> <!-- /.tab-content --> 
                    </div><!-- /.tabbable -->
                </form>
            </div> 
