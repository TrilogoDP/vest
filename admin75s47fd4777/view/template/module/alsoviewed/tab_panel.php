 ...
 <tr>
    ...
    <td class="col-xs-9">
        ...
        <select id="Checker" name="alsoviewed[Enabled]" class="form-control">
            <option value="yes" <?php echo (!empty($data['alsoviewed']['Enabled']) && $data['alsoviewed']['Enabled'] == 'yes') ? 'selected=selected' : '' ?>>Включено</option>
           <option value="no" <?php echo (empty($data['alsoviewed']['Enabled']) || $data['alsoviewed']['Enabled']== 'no') ? 'selected=selected' : '' ?>>Выключено</option>
        </select>
        </div>
   </td>
  </tr>
  <tr>
    ...
    <tr>
        <td class="col-xs-3">
        	<h5><strong>Количество товаров</strong></h5>
           </td>
        <td class="col-xs-9">
            <div class="col-xs-4">
                <div class="input-group">
					...
					<span class="input-group-addon">товаров</span>
                </div>
            </div>
        </td>
    </tr>
  <tr>
     <td class="col-xs-3">
        <h5><strong>Свой CSS</strong></h5>      </td>
     <td class="col-xs-9">
    	<div class="col-xs-4">
