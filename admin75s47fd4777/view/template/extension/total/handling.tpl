      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-handling" class="form-horizontal">
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-total">Максимальное значение скидки</label>
            <div class="col-sm-10">
              <input type="text" name="handling_total" value="<?php echo $handling_total; ?>" placeholder="Максимальное значение скидки" id="input-total" class="form-control" />
            </div>
          </div>
          <div class="form-group">
