    ...
    <table class="table table-bordered table-hover">
      <thead>
        <tr>
		  ...
		  <td class="text-left">Бесплатно от</td>
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <td class="text-left"><span class="label label-success"><?php echo $extension['code']; ?></span></td>
		  <td class="text-left"><span class="label label-danger"><?php echo $extension['free_delivery']; ?></span></td>
