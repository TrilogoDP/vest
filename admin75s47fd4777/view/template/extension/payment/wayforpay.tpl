        ...
        <div class="panel-body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-wayforpay"
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label class="col-sm-4 control-label">Статус при начале оплаты</label>

                    <div class="col-sm-8">
                        <select name="wayforpay_order_status_progress_id" class="form-control">
                            <?php
                                foreach ($order_statuses as $order_status) {

                                $st = ($order_status['order_status_id'] == $wayforpay_order_status_progress_id) ? ' selected="selected" ' : "";
                                ?>
