			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-justin" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="justin_min_total_for_free_delivery" value="<?php echo $justin_min_total_for_free_delivery; ?>" placeholder="<?php echo $justin_min_total_for_free_delivery; ?>" class="form-control" />
						</div>
					</div>
