        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-special" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-marketing_special">Отображать не товары со скидкой, а актуальные акции</label>
                        <div class="col-sm-10">
                            <select name="marketing_special" id="input-marketing_special" class="form-control">
                                <?php if ($marketing_special) { ?>
