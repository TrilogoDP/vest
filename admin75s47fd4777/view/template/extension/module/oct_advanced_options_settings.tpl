				...
				<form method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="setting-tab">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-allow_ean"><?php echo $entry_allow_ean; ?></label>
								<div class="col-sm-10">
									<select name="oct_advanced_options_settings_data[allow_ean]" id="input-allow_ean" class="form-control">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-allow_column_q_ean"><?php echo $entry_allow_column_q_ean; ?></label>
								<div class="col-sm-10">
									<select name="oct_advanced_options_settings_data[allow_column_q_ean]" id="input-allow_column_q_ean" class="form-control">
										<?php if ($oct_advanced_options_settings_data['allow_column_q_ean']) { ?>
											<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
											<option value="0"><?php echo $text_disabled; ?></option>
											<?php } else { ?>
											<option value="1"><?php echo $text_enabled; ?></option>
