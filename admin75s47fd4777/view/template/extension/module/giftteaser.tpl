        ...
        <div class="panel-heading">
            ...
            <div class="storeSwitcherWidget">
            	<div class="form-group">
                	<button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-pushpin"></span>&nbsp;<?php echo $store['name']; if($store['store_id'] == 0) echo $text_default; ?>&nbsp;<span class="caret"></span><span class="sr-only">Раскрыть</span></button>
                ...
                <input type="hidden" name="giftteaser_status" value="1" /> 
                    <div class="tabbable">
                        <div class="tab-navigation">
                          ...
                          <li><a href="#tab_gift" data-toggle="tab"><i class="fa fa-gift"></i>&nbsp;Подарки</a></li>
                    ...
                    <div class="tab-content">
                      ...
                      <div id="isense-support" class="tab-pane hidden"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/'.$modulePath.'/tab_support.php'); ?></div>
                    </div>
                </div>
            </form>
        </div> 
