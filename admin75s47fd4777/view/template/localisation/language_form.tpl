    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-language" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label required" for="input-code2">Код для переключалки</label>
            <div class="col-sm-10">
              <input type="text" name="code2" value="<?php echo $code2; ?>" placeholder="UA" id="input-code2" class="form-control" />
            </div>
          </div>  
