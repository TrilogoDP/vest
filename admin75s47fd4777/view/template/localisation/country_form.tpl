      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-country" class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-name">Название UA</label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-name_ru">Название RU</label>
            <div class="col-sm-10">
              <input type="text" name="name_ru" value="<?php echo $name_ru; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name_ru" class="form-control" />
            </div>
          </div>
