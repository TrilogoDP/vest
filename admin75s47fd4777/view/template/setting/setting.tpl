            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab-misc" data-toggle="tab">VEST</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-misc">
							...
							<div class="form-group">
                                <label class="col-sm-2 control-label" for="input-config_excluded_tax_class_id">Исключенный налоговый класс</label>
                                <div class="col-sm-10">
                                    <select name="config_excluded_tax_class_id" id="input-config_excluded_tax_class_id" class="form-control">
                                    	<option value="0">Не выбрано</option>
                                        <?php foreach ($tax_classes as $tax_class) { ?>
                                            <?php if ($tax_class['tax_class_id'] == $config_excluded_tax_class_id) { ?>
							...
							<div class="alert alert-success">
								Настройки парсера поставщика Мобикинг
							</div>
							
							
							<div class="form-group">
                                <label class="col-sm-2 control-label" for="input-config_mobiking_collisionWords">collisionWords</label>
                                <div class="col-sm-10">
                                   <textarea name="config_mobiking_collisionWords" rows="5" placeholder="" id="input-config_mobiking_collisionWords" class="form-control"><?php echo $config_mobiking_collisionWords; ?></textarea>
                                    <span class="help"><i class="fa fa-info-circle"></i> список значений для различения похожих моделей, через запятую</span>
								</div>
							</div>
							
							<div class="form-group">
                                <label class="col-sm-2 control-label" for="input-config_mobiking_optionCompareAttributesExcludeValueWords">optionCompareAttributes</label>
                                <div class="col-sm-10">
                                    <textarea name="config_mobiking_optionCompareAttributesExcludeValueWords" rows="5" placeholder="" id="input-config_mobiking_optionCompareAttributesExcludeValueWords" class="form-control"><?php echo $config_mobiking_optionCompareAttributesExcludeValueWords; ?></textarea>
                                    <span class="help"><i class="fa fa-info-circle"></i> неизвестные магические названия опций, используются в логике перебора и свертки. через запятую</span>
								</div>
							</div>
						...
						<?php /* ?>	
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-config_3310_suffix">Код прайса поставщика 3310</label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_3310_suffix" value="<?php echo $config_3310_suffix; ?>" placeholder="12345" id="input-config_3310_suffix" class="form-control" />
                                    <span class="help"><i class="fa fa-info-circle"></i> ссылка на загрузку файла выглядит так: <code>https://3310.com.ua/_files/users/110/export_prom.xml?<?php echo $config_3310_suffix; ?></code></span>
								</div>
							</div>
						<?php */ ?>
							
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-config_mma_option_categories">Сворачивать эти категории MMA.IN.UA</label>
								<div class="col-sm-10">
									<textarea name="config_mma_option_categories" rows="5" placeholder="Список категорий" id="input-config_mma_option_categories" class="form-control"><?php echo $config_mma_option_categories; ?></textarea>
									<span class="help"><i class="fa fa-info-circle"></i> Только эти категории будут свернуты в опции. Каждая с новой строки, только названия, или только идентификаторы, как удобнее.<br />Список категорий находится в файле https://vest.in.ua/suppliers/mma.categories.csv <a href="https://vest.in.ua/suppliers/mma.categories.csv"><i class="fa fa-external-link"></i></a>
									</div>
								</div>
								
								<?php /* ?>
								<div class="form-group">	
									<label class="col-sm-2 control-label" for="input-config_ksmua_categories">Категории поставщика KSM UA</label>
									<div class="col-sm-10">
										<textarea name="config_ksmua_categories" rows="5" placeholder="Список категорий" id="input-config_ksmua_categories" class="form-control"><?php echo $config_ksmua_categories; ?></textarea>
										<span class="help"><i class="fa fa-info-circle"></i> Каждая с новой строки, только названия, или только идентификаторы, как удобнее.<br />Список категорий находится в файле https://vest.in.ua/suppliers/ksmua.categories.csv <a href="https://vest.in.ua/suppliers/ksmua.categories.csv"><i class="fa fa-external-link"></i></a>
										</div>
									</div>
								<?php */ ?>	
										
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-config_kievdigital_categories">Категории поставщика KievDigital</label>
											<div class="col-sm-10">
												<textarea name="config_kievdigital_categories" rows="5" placeholder="Список категорий" id="input-config_kievdigital_categories" class="form-control"><?php echo $config_kievdigital_categories; ?></textarea>
												<span class="help"><i class="fa fa-info-circle"></i> Каждая с новой строки, только названия, или только идентификаторы, как удобнее.<br />Список категорий находится в файле https://vest.in.ua/suppliers/kievdigital.categories.csv <a href="https://vest.in.ua/suppliers/kievdigital.categories.csv"><i class="fa fa-external-link"></i></a>
												</div>
											</div>

											<div class="form-group">
													<label class="col-sm-2 control-label">Игнорировать категории KievDigital</label>
													<div class="col-sm-10">
														<label class="radio-inline">
															<?php if ($config_kievdigital_use_all_categories) { ?>
																<input type="radio" name="config_kievdigital_use_all_categories" value="1" checked="checked" />
																<?php echo $text_yes; ?>
																<?php } else { ?>
																<input type="radio" name="config_kievdigital_use_all_categories" value="1" />
																<?php echo $text_yes; ?>
															<?php } ?>
														</label>
														<label class="radio-inline">
															<?php if (!$config_kievdigital_use_all_categories) { ?>
																<input type="radio" name="config_kievdigital_use_all_categories" value="0" checked="checked" />
																<?php echo $text_no; ?>
																<?php } else { ?>
																<input type="radio" name="config_kievdigital_use_all_categories" value="0" />
																<?php echo $text_no; ?>
															<?php } ?>
														</label>
														<br /><span class="help"><i class="fa fa-info-circle"></i> если включено, то список категорий игнорируется, и загружаются все категории</span>
													</div>
													
												</div>
											
											<div class="form-group">
												<label class="col-sm-2 control-label" for="input-pricehistory">Граничные изменения цен</label>
												<div class="col-sm-10">
													<textarea name="config_pricehistory" rows="5" placeholder="1000:30-75" id="input-pricehistory" class="form-control"><?php echo $config_pricehistory; ?></textarea>
													<span class="help"><i class="fa fa-info-circle"></i> мониторинг изменения цен. формат "цена до:мониторинг 1 разницы - мониторинг 1 разницы. вводить от меньшего к большему, каждая формула в новой строке.
													</div>
												</div>
												
												<div class="form-group">
													<label class="col-sm-2 control-label">Запоминать удаляемые SKU</label>
													<div class="col-sm-10">
														<label class="radio-inline">
															<?php if ($config_skudeleted_mode) { ?>
																<input type="radio" name="config_skudeleted_mode" value="1" checked="checked" />
																<?php echo $text_yes; ?>
																<?php } else { ?>
																<input type="radio" name="config_skudeleted_mode" value="1" />
																<?php echo $text_yes; ?>
															<?php } ?>
														</label>
														<label class="radio-inline">
															<?php if (!$config_skudeleted_mode) { ?>
																<input type="radio" name="config_skudeleted_mode" value="0" checked="checked" />
																<?php echo $text_no; ?>
																<?php } else { ?>
																<input type="radio" name="config_skudeleted_mode" value="0" />
																<?php echo $text_no; ?>
															<?php } ?>
														</label>
														<br /><span class="help"><i class="fa fa-info-circle"></i> если включено, то при удалении SKU товаров запоминаются и больше не будут добавлены от поставщиков</span>
													</div>
													
												</div>
												
												<div class="form-group">
												<label class="col-sm-2 control-label" for="input-donotcall-status">Разрешать "не перезванивать"</span></label>
												<div class="col-sm-10">
													<div class="well well-sm" style="height: 150px; overflow: auto;">
														<?php foreach ($order_statuses as $order_status) { ?>
															<div class="checkbox">
																<label>
																	<?php if (in_array($order_status['order_status_id'], $config_donotcall_status)) { ?>
																		<input type="checkbox" name="config_donotcall_status[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
																		<?php echo $order_status['name']; ?>
																		<?php } else { ?>
																		<input type="checkbox" name="config_donotcall_status[]" value="<?php echo $order_status['order_status_id']; ?>" />
																		<?php echo $order_status['name']; ?>
																	<?php } ?>
																</label>
															</div>
													...
													<br /><span class="help"><i class="fa fa-info-circle"></i> если у покупателя есть хотя бы один заказ в одном из этих статусов с присвоенной ТТН, то покажем ему возможность поставить галочку "не перезванивать мне" при оформлении заказа</span>
										...
										<div class="tab-pane" id="tab-local">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<span class="help text-danger"><i class="fa fa-exclamation-circle"></i> Будь-ласка, не змінюйте локалізацію, бо щастя не буде!</span>
												</div>
											</div>
											<div class="form-group">
										...
										<div class="tab-pane" id="tab-option">
											<fieldset>
												...
												<div class="form-group">
													<label class="col-sm-2 control-label" for="input-config_limit_catalog_pc">Переназначить лимит витрины - ПК</label>
													<div class="col-sm-10">
														<input type="number" step="1" name="config_limit_catalog_pc" value="<?php echo $config_limit_catalog_pc; ?>" placeholder="20" id="input-limit_catalog_pc" class="form-control" style="width:100px;" />

														<br /><span class="help">Устройство определяется по юзер-агенту, библиотекой Jaybizzle\CrawlerDetect\CrawlerDetect</span>
													</div>
												</div>

												<div class="form-group">
													<label class="col-sm-2 control-label" for="input-config_limit_catalog_tablet">Переназначить лимит витрины - планшет</label>
													<div class="col-sm-10">
														<input type="number" step="1" name="config_limit_catalog_tablet" value="<?php echo $config_limit_catalog_tablet; ?>" placeholder="20" id="input-config_limit_catalog_tablet" class="form-control" style="width:100px;" />
												...
												<div class="form-group">
													<label class="col-sm-2 control-label" for="input-config_limit_catalog_mobile">Переназначить лимит витрины - мобильный</label>
													<div class="col-sm-10">
														<input type="number" step="1" name="config_limit_catalog_mobile" value="<?php echo $config_limit_catalog_mobile; ?>" placeholder="20" id="input-config_limit_catalog_mobile" class="form-control" style="width:100px;" />
										...
										<div class="tab-pane" id="tab-image">
											<div class="form-group">
												<label class="col-sm-2 control-label" for="input-logo"><?php echo $entry_logo; ?><br /><i class="fa fa-info-circle"></i> в большом разрешении, любая ширина. желательно PNG</label>
											...
											<div class="form-group">
												<label class="col-sm-2 control-label" for="input-logo_small">Маленький логотип<br /><i class="fa fa-info-circle"></i> ширина до 300px. желательно PNG</label>
												<div class="col-sm-10"><a href="" id="thumb-logo_small" data-toggle="image" class="img-thumbnail"><img src="<?php echo $logo_small; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
													<input type="hidden" name="config_logo_small" value="<?php echo $config_logo_small; ?>" id="input-logo_small" />
												</div>
											</div>
