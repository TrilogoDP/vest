  ...
  <table id="option-value-<?php echo $option_row; ?>" class="be-list">
   ...
   <tbody id="option-value-row-<?php echo $option_value_row; ?>">
    <tr>
	 ...
	 <!--//***mf begin -->
	 <td class="right">
		<input type="text" name="option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][sku]" value="<?php echo $product_option_value['sku']; ?>" />
		<input type="text" name="option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][o_v_image]" value="<?php echo $product_option_value['o_v_image']; ?>" hidden />
	</td>
	<!--//***mf end -->	 
