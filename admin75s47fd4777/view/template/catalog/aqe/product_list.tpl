						...
						<div class="collapse navbar-collapse" id="bull5i-navbar-collapse">
							<div class="navbar-right">
								...
								<div class="nav navbar-nav btn-group">
									<button type="button" class="btn btn-info" data-toggle="tooltip" data-container="body" data-placement="bottom" title="Копировать iNobi Matte" data-url="<?php echo $copyInobiMatte; ?>" id="btn-copy-inobi-matte" data-form="#pqe-list-form" data-context="#content" data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $text_copying; ?>" disabled><i class="fa fa-files-o"></i> <span class="visible-lg-inline visible-xs-inline">Копировать iNobi Matte (2)</span></button>

									<button type="button" class="btn btn-warning" data-toggle="tooltip" data-container="body" data-placement="bottom" title="Копировать Privacy Matte" data-url="<?php echo $copyPrivacyMatte; ?>" id="btn-copy-privacy-matte" data-form="#pqe-list-form" data-context="#content" data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $text_copying; ?>" disabled><i class="fa fa-files-o"></i> <span class="visible-lg-inline visible-xs-inline">Копировать Privacy Matte (1)</span></button>
									...
									<tr>
										<?php foreach($columns as $col) {
											...
											<td class="<?php echo $column_info[$col]['align']; ?><?php echo ($column_info[$col]['qe_status']) ? ' ' . $column_info[$col]['type'] : ''; ?>" id="<?php echo $col . "-" . $product['product_id']; ?>"><?php echo $product[$col]; ?>
												...
												<?php if ($col == 'price') { ?>
													<?php if (($product['dnup'])) { ?>
														<br /><span class="label label-success">НЦ 
														<?php if (($product['price_date'])) { ?>
															 <?php echo $product['price_date']; ?>
														<?php } ?>
														</span>
													<?php } ?>
												<?php } ?>
												...
												<?php if ($col == 'sku') { ?>
													<?php if (($product['dnmerchant'])) { ?>
														<br /><span class="label label-warning">NO GM</span>
													<?php } ?>
												<?php } ?>

												<?php if ($col == 'id') { ?>
													<?php if (($product['copied_from'])) { ?>
														<br /><span class="label label-warning"><i class="fa fa-copy"></i> <?php echo $product['copied_from']; ?></span>
													<?php } ?>
												<?php } ?>

												<?php if ($col == 'archive') { ?>
													<?php if (($product['archive_auto'])) { ?>
														<br /><span class="label label-danger"><i class="fa fa-exclamation-triangle"></i> авто</span>
													<?php } ?>
												<?php } ?>
