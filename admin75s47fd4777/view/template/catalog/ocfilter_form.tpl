					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-general">
							<table class="form">
								...
								<tr>
									<td>Product Highlight (Google Merchant)</td>
									<td>
								...
								<tr>
									<td>Включить FAQ</td>
									<td>
										<select name="faq" id="input-faq" class="form-control">
											<?php if ($faq) { ?>
												<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
												<option value="0"><?php echo $text_disabled; ?></option>
												<?php } else { ?>
									...
									<li>
										...
										<div class="fields">
											<div class="row">
												...
												<?php if ($image) { ?>
													<div class="col-sm-1">
														<select type="select" name="ocfilter_option_value[update][<?php echo $value['value_id']; ?>][border]">
															<?php if ($value['border']) { ?>											
																<option value="1" selected="selected">Контур</option>
																<option value="0">Без контура</option>
																<?php } else { ?>
																<option value="1">Контур</option>
																<option value="0"  selected="selected">Без контура</option>
															<?php } ?>
														</select>
													</div>
												<?php } ?>
												...
												<?php foreach ($languages as $language) { ?>
													<div class="col-sm-3">
														...
														<label><textarea name="ocfilter_option_value[update][<?php echo $value['value_id']; ?>][language][<?php echo $language['language_id']; ?>][alternate_name]" style="max-width:90%" rows="5" cols="20"><?php echo (isset($value['language'][$language['language_id']]) ? $value['language'][$language['language_id']]['alternate_name'] : ''); ?></textarea>&nbsp;<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></label>
													
													</div>
												<?php } ?>	
												
												<div class="col-sm-1">
													<input type="number" name="ocfilter_option_value[update][<?php echo $value['value_id']; ?>][sort_order]" value="<?php echo $value['sort_order']; ?>" style="width:40px;" />
												</div>
											</div>
										</div>
