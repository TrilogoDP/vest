						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<td class="center">Подбор</td>
									<td class="center">Hightlight</td>
									<td class="center">FAQ</td>
								...
								<?php if ($options) { ?>
									<?php foreach ($options as $option) { ?>
										<tr>
											...
											<td class="right">
												<?php if ($option['selection']) { ?>
													<label><input type="checkbox" class="edit" name="selection" value="1" for="<?php echo $option['option_id']; ?>" checked="checked" /><span><?php echo $text_enabled; ?></span></label>
													<?php } else { ?>
													<label><input type="checkbox" class="edit" name="selection" value="1" for="<?php echo $option['option_id']; ?>" /><span><?php echo $text_disabled; ?></span></label>
												<?php } ?>
											</td>
											
											<td class="right">
												<?php if ($option['highlight']) { ?>
													<label><input type="checkbox" class="edit" name="highlight" value="1" for="<?php echo $option['option_id']; ?>" checked="checked" /><span><?php echo $text_enabled; ?></span></label>
													<?php } else { ?>
													<label><input type="checkbox" class="edit" name="highlight" value="1" for="<?php echo $option['option_id']; ?>" /><span><?php echo $text_disabled; ?></span></label>
												<?php } ?>
											</td>
											
											<td class="right">
												<?php if ($option['faq']) { ?>
													<label><input type="checkbox" class="edit" name="faq" value="1" for="<?php echo $option['option_id']; ?>" checked="checked" /><span><?php echo $text_enabled; ?></span></label>
													<?php } else { ?>
													<label><input type="checkbox" class="edit" name="faq" value="1" for="<?php echo $option['option_id']; ?>" /><span><?php echo $text_disabled; ?></span></label>
												<?php } ?>
											</td>
