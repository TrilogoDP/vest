...
<div id="tabs" class="htabs"><a href="#tab-options"><?php echo $tab_options; ?></a>
	<a href="#tab-pagination"><?php echo $tab_pagination; ?></a>
	<a href="#tab-main"><?php echo $tab_main; ?></a>
	<a href="#tab-ex"><?php echo $tab_ex; ?></a>
	<a href="#tab-other"><?php echo $tab_other; ?></a>
	<a href="#tab-install"> <?php echo $entry_install_update; ?></a>
</div>
...
<div id="tab-options">
	<table class="mynotable" style="margin-bottom:20px; background: white; vertical-align: center;">
					...
					<tr>
					  <td><?php echo $entry_widget_status; ?> <?php if (SC_VERSION > 15) { ?><i class="fa fa-compass" aria-hidden="true"></i> <?php } ?><?php echo strip_tags($heading_title); ?>&nbsp;<?php echo $langmark_version; ?></td>
					  <td>
	 ...
	 foreach ($languages as $lang) { ?>
	  <tr>
         ...
         <?php if ($lang['language_id'] == $config_language_id) { ?>
         <br><span class='lang-default'><?php echo $entry_lang_default; ?></span>
         <?php } ?>
	...
	<tr>
		...
		<td>
				...
				<div class="input-group">
				<select class="form-control" name="asc_langmark[prefix_switcher][<?php echo $lang['code'];?>]">
                  <?php if (isset($asc_langmark['prefix_switcher'][$lang['code']]) && $asc_langmark['prefix_switcher'][$lang['code']]) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
				...
				<div class="input-group">
				<select class="form-control" name="asc_langmark[hreflang_switcher][<?php echo $lang['code'];?>]">
                  <?php if (isset($asc_langmark['hreflang_switcher'][$lang['code']]) && $asc_langmark['hreflang_switcher'][$lang['code']]) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
	  ...
	  <tr>
		...
		<td></td>
          ...
          <tr>
              ...
              <td>
              <div class="input-group"><select class="form-control" name="asc_langmark[currency_switch]">
	  ...
	  <tr>
		...
		<td></td>
          ...
          <tr>
              ...
              <td>
              <div class="input-group"><select class="form-control" name="asc_langmark[use_link_status]">
...
<script>
function delayer(){
    window.location = 'index.php?route=catalog/langmark&<?php echo $token_name; ?>=<?php echo $token; ?>';
}
</script>
