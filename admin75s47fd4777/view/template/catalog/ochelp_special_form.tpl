			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-special" class="form-horizontal">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab-in-one" data-toggle="tab">1 + 1 = 3</a></li>
					...
					<div class="tab-content">
							...
							<div class="tab-content">
								<?php foreach ($languages as $language) { ?>
									<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-label<?php echo $language['language_id']; ?>">Стикер на товаре: текст</label>
											<div class="col-sm-10">
												<input type="text" name="special_description[<?php echo $language['language_id']; ?>][label]" value="<?php echo isset($special_description[$language['language_id']]) ? $special_description[$language['language_id']]['label'] : ''; ?>" placeholder="<?php echo $entry_meta_h1; ?>" id="input-label<?php echo $language['language_id']; ?>" class="form-control" />
											
											</div>
										</div>
										
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-label_color<?php echo $language['language_id']; ?>">Стикер на товаре: цвет</label>
											<div class="col-sm-10">
												<input type="text" name="special_description[<?php echo $language['language_id']; ?>][label_color]" value="<?php echo isset($special_description[$language['language_id']]) ? $special_description[$language['language_id']]['label_color'] : ''; ?>" placeholder="<?php echo $entry_meta_h1; ?>" id="input-label_color<?php echo $language['language_id']; ?>" class="form-control color" />
											
											</div>
										</div>
										
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-label_bg<?php echo $language['language_id']; ?>">Стикер на товаре: бэкграунд</label>
											<div class="col-sm-10">
												<input type="text" name="special_description[<?php echo $language['language_id']; ?>][label_bg]" value="<?php echo isset($special_description[$language['language_id']]) ? $special_description[$language['language_id']]['label_bg'] : ''; ?>" placeholder="<?php echo $entry_meta_h1; ?>" id="input-label_bg<?php echo $language['language_id']; ?>" class="form-control color" />
										...
										<div class="form-group">
											<label class="col-sm-2 control-label">Картинка<br /><i class="fa fa-info-circle"></i> для списка, 460 на 200</label>
											<div class="col-sm-3">
												<a href="" id="thumb-image-<?php echo $language['language_id']; ?>" data-toggle="image" class="img-thumbnail">
													
													<img src="<?php echo isset($special_description[$language['language_id']]) ? $special_description[$language['language_id']]['thumb'] : ''; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" />
												</a>
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<a href="" id="thumb-banner-<?php echo $language['language_id']; ?>" data-toggle="image" class="img-thumbnail">
													...
													<img src="<?php echo isset($special_description[$language['language_id']]) ? $special_description[$language['language_id']]['banner_thumb'] : ''; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" />
												</a>
						...
						<div class="tab-pane" id="tab-in-one">
							<div class="form-group">
								<label class="col-sm-2 control-label">Включить категории</label>
								<div class="col-sm-10">
										...
										<table class="table table-striped">
											<?php foreach ($categories as $category) { ?>
												<tr>
													<td class="checkbox">
														<label>
															<?php if (in_array($category['category_id'], $special_to_category_x)) { ?>
																<input type="checkbox" name="special_to_category_x[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
																<?php echo $category['name']; ?>
																<?php } else { ?>
																<input type="checkbox" name="special_to_category_x[]" value="<?php echo $category['category_id']; ?>" />
																<?php echo $category['name']; ?>
															<?php } ?>
														</label>
													</td>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">Количество в корзине</label>
								<div class="col-sm-8">
									<div class="input-group date">
										<input type="text" class="form-control" name="amount_in_cart" value="<?php echo $amount_in_cart; ?>" id="input-amount_in_cart" />
										<span class="input-group-btn">
											<button class="btn btn-default" type="button">штук</button>
										</span>
									</div>
									<span class="help"><i class="fa fa-info-circle"></i> количество товаров в корзине из выбранных выше категорий для получения скидки</span>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">Количество подарка / скидки</label>
								<div class="col-sm-8">
									<div class="input-group date">
										<input type="text" class="form-control" name="amount_of_present" value="<?php echo $amount_of_present; ?>" id="input-amount_of_present" />
										<span class="input-group-btn">
											<button class="btn btn-default" type="button">штук</button>
										</span>
									</div>
									<span class="help"><i class="fa fa-info-circle"></i> количество самых дешевых товаров в корзине из выбранных выше категорий, от цены которых будет скидка в размере процента, указанного ниже</span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div class="input-group date">
										<input type="text" class="form-control" name="discount_percent" value="<?php echo $discount_percent; ?>" id="input-amount_of_present" />
										<span class="input-group-btn">
											<button class="btn btn-default" type="button">%</button>
										</span>
									</div>
									<span class="help"><i class="fa fa-info-circle"></i> процент скидки от цены товара, можно указать 100</span>
								</div>
							</div>
						</div>
						<div class="tab-pane" id="tab-data">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-date-added">Дата начала</label>
								<div class="col-sm-4">
									<div class="input-group date">
						...
						<div class="tab-pane" id="tab-special">
							<div id="add-multiple" class="well" style="padding:20px;">
								<div class="row">
									<div class="col-sm-4 pull-left">
										<div class="form-group" style="padding-left:15px; padding-right:15px;">                                 
											<label class="control-label" for="input-category_id">Добавить всю категорию</label>
											<select id="category_id" name="category_id" class="form-control" style="max-width:300px;">
									...
									<div class="col-sm-4 pull-right">
										<div class="form-group" style="padding-left:15px; padding-right:15px;">
											<label class="control-label" for="input-category_id">Добавить весь бренд</label>
											<select id="input-manufacturer" name="manufacturer_id" class="form-control" style="max-width:300px;">
												<option value="0" selected="selected"><?php echo $text_none; ?></option>
								...
								<div class="row">
									<div class="col-sm-12">
										<span class="help"><i class="fa fa-info-circle"></i> Если выбрать одновременно категорию и бренд, то добавлены будут товары бренда из категории, если выбрать только категорию, либо только бренд, то будут выбраны соответственно все товары категории, либо все товары бренда</span>
									</div>
								</div>
							</div>
								...
								<table id="special" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<td class="text-left">Процент
												<input type="text" id="set-all-percents" value="0" placeholder="0" class="form-control" onkeyup="$('.product-special-percent').val($(this).val());" />										
											</td>
											<td></td>
										</tr>
									</thead>
											...
											<tr id="special-row<?php echo $special_row; ?>">
												...
												<td class="text-left">
													<?php foreach ($product['current_specials'] as $current_special) { ?>
														<?php if ($current_special['priority'] == 10) { ?>
															<span class="label label-warning">1C <?php echo $current_special['price']; ?></span><br />
															<?php } elseif ($current_special['priority'] == 5) { ?>
															<span class="label label-info">МОД <?php echo $current_special['price']; ?></span><br />
															<?php } else { ?>
												...
												<td class="text-left" style="width: 10%;">
												<input type="text" name="special_product[<?php echo $special_row; ?>][percent]" value="<?php echo $product['percent']; ?>" placeholder="0" class="form-control product-special-percent" /></td>
