    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-general">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<span class="help">
										<i class="fa fa-info-circle"></i> этот бренд будет спрятан из списка
									</span>
								</div>
							</div>
		  ...
		  <div class="panel-heading text-center">
            <label class="panel-title" for="input-data-tab">Данные для Epicentr</label>
          </div>

		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sort-order">Коэффициент наценки</label>
            <div class="col-sm-10">
              <input type="text" name="epicentr_coeff" value="<?php echo $epicentr_coeff; ?>" placeholder="Например 1.1 - это +10% к стоимости" id="input-epicentr_coeff" class="form-control" />
            </div>
          </div>
