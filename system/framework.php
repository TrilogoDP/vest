<?php
	...
	$registry->set('isMobile', $registry->get('mobileDetect')->isMobile());
	$registry->set('isTablet', $registry->get('mobileDetect')->isTablet());
	$registry->set('isPC', (!$registry->get('mobileDetect')->isTablet() && !$registry->get('mobileDetect')->isMobile()));
	
	// Cache 
	$registry->set('cache', new Cache($config->get('cache_type'), $config->get('cache_expire'), $registry));
