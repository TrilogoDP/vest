...
final class Loader {
	...
	public function view($route, $data = array()) {
		...
		if (!$output) {
			...
			$template->set('isMobile', $this->registry->get('isMobile'));
			$template->set('isTablet', $this->registry->get('isTablet'));
			$template->set('isPC', (!$this->registry->get('isMobile') && !$this->registry->get('isTablet')));
