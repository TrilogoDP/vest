...
function colorToEng($color){
	$colors = ['Черный:Чорний:black',
	'Белый:білий:white',
	'Красный:червоний:red',
	'Зеленый:зелений:green',
	'Синий:синій:blue',
	'Желтый:жовтий:yellow',
	'Голубой:голубий:blue',
	'Оранжевый:оранжевий:orange',
	'Фиолетовый:фіолетовий:purple',
	'Прозрачный:прозорий:transparent',
	'Кремовый:кремовий:creamy',
	'Серебряный:срібний:silver',
	'Темно-серый:темно-сірий:dark gray',
	'Розовый:рожевий:pink',
	'Кораловый:кораловий:coral',
	'Серый:сірий:gray',
	'Бирюзовый:бірюзовий:Turquoise',
	'черно-красный:чорно-червоний:black and red',
	'Темно-синий:темно-синій:dark blue',
	'Золотой:золотий:golden',
	'Коричневый:коричневий:brown',
	'Кофейный:кофейний:coffe',
	'Бронзовий:Бронзовый:Bronze',
	'Стальной:Сталевий:Steel',
	'Бежевый:Бежевий:Beig',
	'оливковый :Оливковий:Olive',
	'темно-коричневый:Темно-коричневий:dark brown',
	'Светло Золотой:Світло-золотий:Light golden',
	'бордовый:Бордовий:burgundy',
	'светло-голубой:Світло-блакитний:Light blue',
	'серо-голубой:Сіро-блакитний:gray-blue',
	'бледно-синий:Блідо-синій:pale blue',
	'светло-серый:Світло-сірий:Light gray',
	'Лимонный:Лимонний:Lemon',
	'Графитный:Графітний:Graphite',
	'Синий индиго:Синій індиго:Indigo Blue',
	'бело-стальной:БІло-сталевий:white-steel',
	'Черно-серый:Чорно-сірий:Black and gray',
	'Черно-золотой:Чорно-золотий:Black and gold',
	'Светло-розовый:Світло-рожевий:Light pink',
	'Сиреневый:Бузковий:Lilac',
	"Мятный:М'ятний:Peppermint",
	'Графитовый:Графітовий:Graphit',
	'Салатовый:Салатовий:Lettuce',
	'Персиковый:Персиковий:Peach',
	'Малиновый:Малиновий:Raspberry',
	'Темно-зеленый:Темно-зелений:Dark green',
	'Светло-коричневой:Світло-коричневий:Light brown',
	'Градиент:Градієнт:Gradient',
	'Пурпурный:Пурпуровий:Purple',
	'Хаки:Хакі:Hacks',
	'темно-малиновый:Темно-малиновий:dark crimson',
	'гранатовый:Гранатовий:Garnet',
	'лиловый:Ліловий:purple',
	'пастельно-розовый:Пастельно-рожевий :Pastel pink',
	'зелено-серый: Зелено-сірий:green and gray',
	'Черно-синий:Чорно-синій:Black and blue',
	'Розово-голубой:Рожево-блакитний:Pink and blue',
	'Кобальтовый:Кобальтовий:Cobalt',
	'Чёрно-Сиреневый:Чорно-бузковий:Black and lilac',
	'Салатово-Бирюзовый:Салатово-бірюзовий:Lettuce and turquoise',
	'Красно-Золотой:Червоно-золотой:Red and gold',
	'Светло-красный:Світло-червоний:Light red',
	'Розово-Золотой:Рожево-золотий:Rose Gold',
	'Металик:Металік:Metallic',
	'Черно-белый:Чорно-білий:Black and white',
	'Светло-Зеленый:Світло-зелений:Light Green',
	'Вишневый:Вишневий:Cherry'];
	...
	foreach ($colors as $line){
		...
		$arr1[] = mb_strtolower($exploded[0]);
		$arr2[] = mb_strtolower($exploded[1]);
		$arr3[] = $exploded[2];
	}

	$color = str_ireplace($arr1, $arr3, $color);
	$color = str_ireplace($arr2, $arr3, $color);
