		...
		<script type="application/ld+json">
			{
				...
				"productID": "mpn:<?php echo $micro_mpn; ?>",
				"model": "<?php echo strip_tags($model); ?>",
				"sku": "<?php echo strip_tags($micro_sku); ?>",
				"mpn": "<?php echo $micro_mpn; ?>",
				<?php if ($manufacturer) { ?>
					"brand": {
						"@type": "Thing",
				...
				<?php } ?>
				"description": "<?php echo prepareEcommString(strip_tags(preg_replace('/<\/font[^>]*>/', '', preg_replace('/<font[^>]*>/', '', $description))));  ?>",			
				<?php if ($rating) { ?>
					"aggregateRating": {
	...
	<body>
				...
				<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
					...
					<?php foreach ($breadcrumbs as $key => $breadcrumb) { ?>
						<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">						
							<a href="<?php echo $breadcrumb['href']; ?>"><span itemprop="name"><?php echo $breadcrumb['text']; ?></span></a>
		...
		<amp-analytics type="gtag" data-credentials="include">
			<script type="application/json">
				{
				"vars" : {
				"gtag_id": "UA-73080915-1",
				"config" : {
				"UA-73080915-1": { "groups": "default" }
				}
				}
				}
			</script>
