<?php if ($products) { ?>
<section id="also-viewed-products" class="bg-light-yellow product-carusel" name="also-viewed-products">
	<?php if ($position == "column_left" OR $position == "column_right") { ?>
		...
		<div id="owl-carousel-module-alsoviewed-<?php echo $module; ?>" class="owl-carousel owl-theme shadow ">
		...
		<script>
			...
			<?php if (isset($oct_lazyload) && $oct_lazyload) { ?>
				setTimeout(function() {
					$("#owl-carousel-module-alsoviewed-<?php echo $module; ?> img.lazy-module").lazyload({
						effect : "fadeIn"
					});
				}, 10);
			<?php } ?>
			
			$('#owl-carousel-module-alsoviewed-<?php echo $module; ?>').owlCarousel({
				responsive:{
			        0:{
			            items:2,
			            margin:0,
