...
<html>
	...
	<body style="font-size: 12px; line-height:18px; font-family: Arial, sans-serif; background:#FFF;">
		<div style="max-width: 1000px; margin: 0 auto;">
			...
			<main style="background: #fff; position: relative; box-shadow: 0 0 13px 0 rgba(0, 0, 0, .4);">
				<div class="order-details">
					<div style="border-bottom: 1px dashed #e5e5e5; padding: 20px; background: #2B3743; color: #fff; font-size: 16px;">
						...
						<table style="font-size: 14px; line-height: 22px;">
							<tbody>
								<tr style="border-bottom: 1px solid #ecedf3;">
									...
									<td style="padding: 5px 8px 5px 2px;"><?php echo preg_replace("/<img[^>]+\>/i", "", $payment_method); ?></td>
								</tr>
								<?php if ($shipping_method) { ?>
									<tr style="border-bottom: 1px solid #ecedf3;">
										<td style="padding: 5px 8px 5px 2px;"><?php echo $text_shipping_method; ?></td>
										<td style="padding: 5px 8px 5px 2px;"><?php echo preg_replace("/<img[^>]+\>/i", "", $shipping_method); ?></td>
									</tr>
								<?php } ?>
								<tr style="border-bottom: 1px solid #ecedf3;">
					...
					<div>
						<div class="order-goods">
							<table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
								<thead>
									<tr>										
										<td colspan="2" style="font-size: 12px; border-right: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5; background-color: #078A7E; font-weight: bold; text-align: center; padding: 7px; color: #fff;"><?php echo $text_product; ?></td>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5; background-color: #078A7E; font-weight: bold; text-align: left; padding: 7px; color: #fff;"><?php echo $text_model; ?></td>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5; background-color: #078A7E; font-weight: bold; text-align: right; padding: 7px; color: #fff;"><?php echo $text_quantity; ?></td>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5; background-color: #078A7E; font-weight: bold; text-align: right; padding: 7px; color: #fff;"><?php echo $text_price; ?></td>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5; background-color: #078A7E; font-weight: bold; text-align: right; padding: 7px; color: #fff;"><?php echo $text_total; ?></td>
									</tr>
								</thead>
								<tbody>
									<?php foreach ($products as $product) { ?>
										<tr>
											<td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: center; padding: 7px;" width="1">
			...
			<div style="color: #757575; font-size: 12px; text-align: center; margin: 30px 0;">
				...
				<?php } ?>
				<br />
				<p style="margin-top: 20px; margin-bottom: 20px;"><?php echo $mf_text_social; ?></p>
				<?php if ($oct_techstore_data['ps_facebook_id']) { ?>
					<a href="<?php echo $oct_techstore_data['ps_facebook_id']; ?>" alt="facebook"><i class="fa fa-facebook-square" aria-hidden="true"></i> <img src="<?php echo $config_url; ?>/image/mail/mail_fb.png" /></a>
				<?php } ?>
				<?php if ($oct_techstore_data['ps_vk_id']) { ?>
					<a href="<?php echo $oct_techstore_data['ps_vk_id']; ?>" alt="vk"><i class="fa fa-vk" aria-hidden="true"></i> <img src="<?php echo $config_url; ?>/image/mail/mail_vk.png" /></a>
				<?php } ?>
				...
				<?php if ($oct_techstore_data['ps_instagram']) { ?>
					<a href="<?php echo $oct_techstore_data['ps_instagram']; ?>" alt="instagram"><i class="fa fa-instagram" aria-hidden="true"></i> <img src="<?php echo $config_url; ?>/image/mail/mail_instagram.png" /></a>
				<?php } ?>
				<?php if ($oct_techstore_data['ps_youtube_id']) { ?>
					<a href="<?php echo $oct_techstore_data['ps_youtube_id']; ?>" alt="youtube"><img src="<?php echo $config_url; ?>/image/mail/mail_youtube.png" /></a>
				<?php } ?>
				<br /><br /><br />
			</div>
		</div>
