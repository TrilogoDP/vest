			...
			<div class="box-content" id="sstore-3-level">
				<?php foreach ($categories as $category) { ?>
					<div class="row ocf-option-values">
						<div class="col-xs-10"><a class="ajaxable-container-reloader" onclick="do_ajax_content_reload($(this)); return false;"  data-href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></div>
