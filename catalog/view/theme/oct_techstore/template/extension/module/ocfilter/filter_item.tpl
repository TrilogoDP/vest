<?php
  $wfViewBlockClass = ' webfun_disabled2';

  if ($option['type'] != 'slide' && $option['type'] != 'slide_dual' && !$option['selectbox']) {
...
?>
<div class="list-group-item ocfilter-option<?php if (isset($option['sort_order']) && $option['sort_order'] == '-2') { echo ' webfun_disabled1'; } echo $wfViewBlockClass; ?>" id="option-<?php echo $option['option_id']; ?>" data-wf-sort="<?php echo isset($option['sort_order']) ? $option['sort_order'] : ''; ?>">
