      ...
      <div class="col-sm-<?php if (($oct_popup_view_data['image'] || $oct_popup_view_data['additional_image']) && ($thumb || $images)) { ?>6<?php } else { ?>12<?php } ?>">
        ...
        <div id="product">
          ...
          <div class="row product-buttons-row">
            <div class="col-sm-12">
              ...
              <?php } ?>				
                ...
                <a style="display:none;" data-effect="mfp-zoom-out" onclick="get_oct_popup_purchase('<?php echo $product_id; ?>');" class="oct-button button-one-click" title="<?php echo $text_oct_popup_purchase; ?>"><i class="fa fa-hand-pointer-o" aria-hidden="true"></i> <?php echo $text_oct_popup_purchase; ?></a>
                <?php } ?>
                <?php if ($oct_popup_view_data['wishlist']) { ?>
                <a data-effect="mfp-zoom-out" rel="noindex nofollow" onclick="get_oct_popup_add_to_wishlist('<?php echo $product_id; ?>');" class="oct-button button-wishlist" title="<?php echo $button_wishlist; ?>"><i class="fa fa-heart"></i></a>
                <?php } ?>
                <?php if ($oct_popup_view_data['compare']) { ?>
                <a data-effect="mfp-zoom-out" rel="noindex nofollow" onclick="get_oct_popup_add_to_compare('<?php echo $product_id; ?>');" class="oct-button button-compare" title="<?php echo $button_compare; ?>"><i class="fa fa-sliders" aria-hidden="true"></i></a>
                <?php } ?>
              </div>
              <?php if ($minimum > 1) { ?>
              <br/>
              ...
              <?php } ?>
				  ...
				  <div id="oneclick-popup">
					...
					<form method="post" enctype="multipart/form-data" id="purchase-form" class="popup-form-box">
						...
						<input name="product_id" value="<?php echo $product_id; ?>" style="display: none;" type="hidden" />
						<input type="text" name="firstname" value="Quick Order Category" style="display: none;" type="hidden" >
						...
						<div class="popup-buttons-box"><a class="popup-button" id="popup-checkout-button" onclick="ga('send', 'event', 'quick_order', 'click'); "><?php echo $text_call_me; ?></a></div>					
						</div>
					</form>
				  </div>
				  <?php } ?>
          ...
          <ul class="list-unstyled product-info-ul">
            ...
            <?php } ?>
            <li class="product-info-li"><span><?php echo $text_sku; ?></span> <?php if ($oct_advanced_options_settings_data['allow_model']) { ?><strong id="main-product-model" style="font-weight: normal;"><?php echo $sku; ?></strong><?php } else { ?><?php echo $sku; ?><?php } ?></li>
            <?php if ($reward) { ?>
          ...
          <?php if ($garanted_text) { ?>
            ...
            <div class="product-advantages-box">
              <div class="row">
                ...
                <div class="col-md-12 product-advantages-item">
