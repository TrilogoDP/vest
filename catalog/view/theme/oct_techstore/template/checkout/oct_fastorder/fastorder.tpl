										...
										<div class="panel-body">
											...
											<div class="oct-bottom-cart-box">
												...
												<div class="oct-bottom-cart-total-cart">
													...
													<div class="total-text text-right"><?php echo $total['title']; ?>: <span><?php echo $total['text']; ?></span></div>
													<?php } ?>
												</div>
											</div>
										</div>
								...
								<div class="panel-body">
									<?php if ($oct_fastorder_data['customer_groups'] == 1 && $customer_groups) { ?>
										<div class="form-group">
											...
											<div class="radio">
												<label><input type="radio"  name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" checked="checked" /><span><?php echo $customer_group['name']; ?></span></label>
											</div>
											<?php } else { ?>
											<div class="radio">
												<label><input type="radio" checked="checked" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" /><span><?php echo $customer_group['name']; ?></span></label>
											</div>
											<?php } ?>
											<?php } ?>
										</div>
															...
															<div class="">
																<div id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>">
																	...
																	<div class="radio">
																		...
																		<span><?php echo $custom_field_value['name']; ?></span></label>
																	</div>
																	<?php } ?>
																</div>
															</div>
