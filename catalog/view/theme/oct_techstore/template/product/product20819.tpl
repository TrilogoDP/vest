      	 ...
      	 <ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
		    <?php foreach ($breadcrumbs as $count => $breadcrumb) { ?>
		        ...
		        <?php } elseif($count+1<count($breadcrumbs)) { ?>
					...
					<a itemscope itemtype="https://schema.org/Thing" itemprop="item" itemid="<?php echo $breadcrumb['href']; ?>" href="<?php echo $breadcrumb['href']; ?>" title="<?php echo $breadcrumb['text']; ?>">
          ...
          <div class="<?php echo $class; ?> left-info">
            ...
            <ul>
              ...
              <li class="image thumbnails-one thumbnail">
                ...
                <img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>"  width="705px" height="705px" class="img-responsive" alt="<?php echo $heading_title; ?>" />
                </a>
              </li>
              <?php } ?>
              <?php } ?>
            ...
            <div class="row after-header-row">
              ...
              <div class="col-sm-4 col-xs-12 product-rating-box">
                <div class="after-header-item">
                  ...
                  <span class="rating" <?php if ($tech_pr_micro == "on" && $rating_data>0) { ?> itemprop="aggregateRating" itemscope="" itemtype="https://schema.org/AggregateRating"<?php } ?>>
              ...
              <div class="row product-buttons-row">
                <div class="col-sm-12">
                  <div class="product-buttons-box<?php if ($disable_buy != 0) { ?> preorder-buttons-box<?php } ?>">
                    ...
                    <?php if ($disable_buy == 0) { ?>
                    <a href="javascript:void(0);" data-toggle="tooltip" rel="noindex nofollow" id="button-cart" title="<?php echo $button_cart; ?>" data-loading-text="<?php echo $text_loading; ?>" class="oct-button"><i class="fa fa-shopping-basket" aria-hidden="true"></i> <span class="hidden-sm hidden-xs"><?php echo $button_cart; ?></span></a>
                    ...
                    <a style="display:none;" href="javascript:void(0);" data-toggle="tooltip" class="oct-button button-one-click" title="<?php echo $text_oct_popup_purchase; ?>" rel="noindex nofollow" onclick="get_oct_popup_purchase('<?php echo $product_id; ?>');"><i class="fa fa-hand-pointer-o" aria-hidden="true"></i> <span class="hidden-sm hidden-xs"><?php echo $text_oct_popup_purchase; ?></span></a>
                    <?php } ?>
                    <a href="javascript:void(0);" data-toggle="tooltip" class="oct-button button-wishlist" title="<?php echo $button_wishlist; ?>" rel="noindex nofollow" onclick="get_oct_popup_add_to_wishlist('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i></a>
                    <a href="javascript:void(0);" data-toggle="tooltip" class="oct-button button-compare" title="<?php echo $button_compare; ?>" rel="noindex nofollow" onclick="get_oct_popup_add_to_compare('<?php echo $product_id; ?>');"><i class="fa fa-sliders" aria-hidden="true"></i></a>
                  </div>
				  <!-- One click simple BEGIN -->
				  <?php if($outofstock == false){ ?>
				  <div id="oneclick-popup">
					<form method="post" enctype="multipart/form-data" id="purchase-form" class="popup-form-box">
						<p class="popup-form-box__title"><?php echo $text_oct_popup_purchase; ?></p>
						<input name="product_id" value="<?php echo $product_id; ?>" style="display: none;" type="hidden" />
						<input type="text" name="firstname" value="Quick Order" style="display: none;" type="hidden" >
						<input type="email" name="email" value="qo@ukr.net" style="display: none;" type="hidden" >
						<input type="tel" name="telephone" placeholder="<?php echo $enter_telephone; ?>" value="" class="">
     ...
     //      }
							  ...
							  success: function(json) {
								...
								if (json['error']) {
								  ...
								  if (json['output']) {
									...
									var skue = ($("#main-product-sku").text());
									var categ = ($("ul.breadcrumb>li:nth-child(3)>a>span").text());
									var perprice = ($(".micro-price").text());
									var coins = $("#input-quantity").val();
									ga('require', 'ecommerce');
									ga('ecommerce:addTransaction', {
									  'id': timestamp,                    
									  'affiliation': 'Vest.in.ua',   
									  'revenue': price,                                  
									});
              ...
              <div class="product-advantages-box">
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-12 product-advantages-item">
            ...
            <div id="oct-related" class="owl-carousel owl-theme">
              ...
              <div class="item" title="<?php echo $product['name']; ?>">
                ...
                <div class="cart">
                  ...
                  <a class="button-cart oct-button" title="<?php echo $button_cart; ?>" rel="noindex nofollow" onclick="get_oct_popup_add_to_cart('<?php echo $product['product_id']; ?>', '1');"><i class="fa fa-shopping-basket" aria-hidden="true"></i> <?php echo $button_cart; ?></a>
                  <?php } else { ?>
                  ...
                  <?php } ?>
                  <a rel="noindex nofollow" onclick="get_oct_popup_add_to_wishlist('<?php echo $product['product_id']; ?>');" title="<?php echo $button_wishlist; ?>" class="wishlist oct-button"><i class="fa fa-heart" aria-hidden="true"></i></a>
                  <a rel="noindex nofollow" onclick="get_oct_popup_add_to_compare('<?php echo $product['product_id']; ?>');" title="<?php echo $button_compare; ?>" class="compare oct-button"><i class="fa fa-sliders" aria-hidden="true"></i></a>
                </div>
              </div>
              <?php } ?>
            </div>
...
<script>
  function oct_option_quantity_minus(e,i) {
    ...
    <?php if ($oct_advanced_options_settings_data['allow_sku']) { ?>
      if ($(e).prev().is(':checked')) {
        $('#main-product-sku').html($(e).prev().attr('data-option-sku'));checkSku()
      } else {
        $('#main-product-sku').html('<?php echo $sku; ?>');
      }
    <?php } ?>
  ...
  function oct_option_quantity_manual(e,i) {
    ...
    <?php if ($oct_advanced_options_settings_data['allow_sku']) { ?>
      if ($(e).prev().prev().is(':checked')) {
        $('#main-product-sku').html($(e).prev().prev().attr('data-option-sku'));checkSku()
      } else {
  ...
  function oct_option_quantity_plus(e,i) {
    ...
    <?php if ($oct_advanced_options_settings_data['allow_sku']) { ?>
      if ($(e).prev().prev().prev().is(':checked')) {
        $('#main-product-sku').html($(e).prev().prev().prev().attr('data-option-sku'));checkSku()
      } else {
        $('#main-product-sku').html('<?php echo $sku; ?>');
      }
    <?php } ?>
