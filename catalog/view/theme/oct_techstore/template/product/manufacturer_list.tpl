...
<div class="wrap fdc">
    ...
    <div class="wrap manufacturers_list_wrap">
        ...
        <div id="content" class="<?php echo $class; ?>">
            <?php if ($categories) { ?>
                <div class="manufacturers_alfabet">
                ...
                <div class="manufacturers_list">
                    <?php foreach ($categories as $category) { ?>
                        <div class="manufacturers_item">
                            <span id="<?php echo $category['name']; ?>" class="name"><?php echo $category['name']; ?></span>
                            <?php if ($category['manufacturer']) { ?>
                                <?php foreach (array_chunk($category['manufacturer'], 6) as $manufacturers) { ?>
                                    
                                        <?php foreach ($manufacturers as $manufacturer) { ?>
                                            <div class="oct-manufacturer-item">
                                                <?php if ($show_logo) { ?>
                                                    <a href="<?php echo $manufacturer['href']; ?>"><?php echo $manufacturer['name']; ?></a> 
                                                    <sup><span class="badge"><?php echo $manufacturer['total']; ?></span></sup>
