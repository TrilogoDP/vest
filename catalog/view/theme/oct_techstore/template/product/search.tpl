...
<div class="wrap fdc ajax_mf search_page">
		...
		<?php if ($products) {//***mf ?>
			<div class="search-wrap">
				...
				<div id="content" class="<?php echo $class; ?>">					
					...
					<div class="show_more"><button>Показать ещё</button></div>											
						...
						<div id="res-products-wrap">
							<div id="res-products">
								<?php foreach ($products as $product) { ?>
									<div class="product-item product-grid product-layout" title="<?php echo strip_tags($product['name']); ?>">
										<div class="image">
											...
											<?php if (isset($oct_lazyload) && $oct_lazyload) { ?>
												<a href="<?php echo $product['href']; ?>" class="lazy_link">
													<img data-original="<?php echo $product['thumb']; ?>" width="100%" height="258" src="<?php echo $oct_lazyload_image; ?>" class="img-responsive lazy" alt="<?php echo strip_tags($product['name']); ?>" />
												</a>
												<?php } else { ?>
												<a href="<?php echo $product['href']; ?>">

													<img src="<?php echo $product['thumb']; ?>" height="200" class="img-responsive" alt="<?php echo strip_tags($product['name']); ?>" />
										...
										<div class="name <?php if ($product['rating'] === 0) { ?>no_rating<?php } ?>">
											<a href="<?php echo $product['href']; ?>"><?php echo strip_tags($product['name']); ?></a>
										</div>
			...
			<?php } else { //***mf begin ?>
			<?php echo $mf_text_request; ?><br>
			<h2 class="search-header" style="margin:0; padding:0;">‹‹<?php echo $mf_search; ?>››</h2>
			<?php echo $mf_text_request_no; ?><br><br>
		<?php }//***mf end ?>
	</div>
</div>
<div class="container">
...
<script><!--
	...
	if (getWindowWidth() < 560) {
		$( document ).ready(function() {
		  	...
		  	cards.find('.show_more').show();
			
			
			$('.show_more button').click(function() {
			  	cards.find(":hidden").show();
			  	$(this).parent().hide()
			});
		});
	}
