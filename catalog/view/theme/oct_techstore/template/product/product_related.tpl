        ...
        <div class="image">
          <?php if ($product['special']) { ?>
                      ...
                      <?php if ($product['action_stickers']) { ?>
                        <div class="oct-discount-box_wrap">
                          <?php foreach ($product['action_stickers'] as $action_sticker) { ?>
                            <div class="oct-discount-box">                          
                              <span class="label label-danger" style="font-size: 14px; <? if ($action_sticker['label_color']) { ?>color:<? echo $action_sticker['label_color']; ?>!important;<?php } ?> <? if ($action_sticker['label_bg']) { ?>background-color:<? echo $action_sticker['label_bg']; ?>!important;<?php } ?>"><? echo $action_sticker['label']; ?></span> 
                            </div>
                          <?php } ?>  
                        </div>
