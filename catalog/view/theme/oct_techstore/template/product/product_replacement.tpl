<?php if ($products) { ?>
	<div class="oct-carousel-row oct-replacement-row">
		<div class="oct-carousel-box">
			<div class="oct-carousel-header"><?php echo $text_replacement; ?></div>
			<div id="oct-replacement" class="owl-carousel owl-theme">
				<?php foreach ($products as $product) { ?>
					<div class="product-layout product-item product-grid product-layout" title="<?php echo $product['name'] ?>">
					<div class="image">
	...
	<script>
		$(function() {
			<?php if (isset($oct_lazyload) && $oct_lazyload) { ?>
				setTimeout(function() {
					$("#oct-replacement img.lazy").lazyload({
						effect : "fadeIn"
					});
				}, 10);
			<?php } ?>
			
			$('#oct-replacement').owlCarousel({
				items: 4,
				itemsDesktop : [1921,4],
				itemsDesktop : [1199,4],
