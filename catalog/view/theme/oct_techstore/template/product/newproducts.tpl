							...
							<div class="image">
								...
								<?php if (isset($oct_lazyload) && $oct_lazyload) { ?>
									<a href="<?php echo $product['href']; ?>" class="lazy_link">
										<img data-original="<?php echo $product['thumb']; ?>" <?php if ($isMobile) { ?>width="170" height="120"<?php } else { ?>width="100%" height="258"<?php } ?> src="<?php echo $oct_lazyload_image; ?>" class="img-responsive lazy" alt="<?php echo $product['name'] ?>" />
									</a>
									<?php } else { ?>
