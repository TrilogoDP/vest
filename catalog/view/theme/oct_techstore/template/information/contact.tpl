...
<div class="contact-page">
    <div class="wrap fdc">
        ...
        <div class="contact-info-wrap">
            <div class="left-column">
                <?php if ($oct_techstore_cont_contacthtml != '') { ?>
                    <div class="contacthtml-box">
                        <?php echo $oct_techstore_cont_contacthtml; ?>
                    </div>
                <?php } ?>
            </div>
            <div class="right-column">
                <img src="catalog/view/theme/oct_techstore/image/bg-contact-info.jpg" alt="contact-info">
            </div>
        </div>
    </div>    
    <div class="contact-form-box">
        <span class="title-page"><?php echo $text_contact; ?></span>
        <div class="two-column">
            <div class="left-column">
                <img src="catalog/view/theme/oct_techstore/image/bg-contact-form.jpg" alt="contact-form">
            </div>
            <div class="right-column">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <fieldset>
                    ...
                    <div class="form-group required">
                        <textarea placeholder="<?php echo $entry_enquiry; ?>" name="enquiry" rows="3" id="input-enquiry" class="form-control"></textarea>
                    ...
                    <div class="contact-button-box">
                        <input class="btn-green" type="submit" value="<?php echo $button_submit; ?>" />
                    </div>
                  </fieldset>
                </form>
            </div>
    ...
    <?php if ($oct_techstore_cont_contactmap != '') { ?>
        <div class="map-box-wrap">
            <div class="map-box"><?php echo html_entity_decode($oct_techstore_cont_contactmap, ENT_QUOTES, 'UTF-8'); ?></div>      
        </div>
    <?php } ?>
