...
<div class="wrap fdc promotion-page">
    <div class="breadcrumb-box">
        <ul class="breadcrumb">
            ...
            <?php foreach ($breadcrumbs as $count => $breadcrumb) { ?>
                ...
                <?php } elseif($count<count($breadcrumbs)) { ?>
                    <li>
    ...
    <div id="promotion-content" class="row top-row ">
		...
		<? } ?>
		<div class="product-timer-block <? if (!$banner) { ?>no_banner<? } ?>">
			<div class="well">
				<?php if($special_date_diff) { ?>					
					<?php echo $timer_custom_css_styles;?>
					<div class="timer">	
						<?php if (!empty($special_time_start_long)) { ?>
							<div class="text"><?php echo $special_time_start_long; ?></div>
							<?php } else { ?>
...
<script type="text/javascript">
  	...
  	$('#timer-end').countdown('<?php echo date("Y/m/d", strtotime($special_date_diff)); ?>', function(event) {
		...
		+ '<div><span>%D</span><?php echo $text_days; ?></div>'
		+ '<div><span>%H</span><?php echo $text_hours; ?></div>'
		+ '<div><span>%M</span><?php echo $text_minutes; ?></div>'
		+ '<div><span>%S</span><?php echo $text_seconds; ?></div>'));
	});  
