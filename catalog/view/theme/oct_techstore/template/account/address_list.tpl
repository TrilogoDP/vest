<?php echo $header; ?>
<div class="account-page-twoColumn personal_area-page--address_list">
    <div class="wrap fdc">
                        ...
                        <div class="address_list">
                            ...
                            <?php foreach ($addresses as $result) { ?>
                                <div class="address_item">
                                    ...
                                    <div class="controll">
                                        <a href="<?php echo $result['update']; ?>" class="button-edit"><?php echo $button_edit; ?></a>
                                        <span onclick="address_delete('<?php echo $result['address_id']; ?>');" class="button-delete">
    ...
    function address_delete(address_id) {
        $.ajax({
            ...
            success: function(json) {
                ...
                console.log('1 - ' + address_id);
                
                if (json['error']) {
                    console.log('2 - ' + address_id);
                    alert(json['error']);
                } else if (json['success']) {
                    console.log('3 - ' + address_id);
                    alert(json['success']);
                    $('.account_content .address_list').load('index.php?route=account/address .address_list'); 
