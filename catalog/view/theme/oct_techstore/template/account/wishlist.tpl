...
<div class="account-page-twoColumn  personal_area-page--wishlist">
  <div class="wrap fdc">
                ...
                <div class="account_content">
                        ...
                        <div class="row">
                            <?php foreach ($products as $product) { ?>
                                <div class="product-layout product-item product-grid product-layout <?php echo (isset($product['product_preorder_status']) && $product['product_preorder_status'] != 1 && $product['quantity'] <= 0) ? ' no_quantity' : ''?>" title="<?php echo $product['name'] ?>" data-product-id="<?php echo $product['product_id']; ?>" 
                                    ...
                                    <a href="<?php echo $product['remove']; ?>" class="remove_btn" title="<?php echo $button_remove; ?>" class="oct-button oct-button-inv"><i class="fa fa-times"></i></a>
                                    ...
                                    <div class="image">
                                        ...
                                        <?php if (isset($oct_lazyload) && $oct_lazyload) { ?>
                                            <a href="<?php echo $product['href']; ?>" class="lazy_link">
                                                <img data-original="<?php echo $product['thumb']; ?>" height="200" src="<?php echo $oct_lazyload_image; ?>" class="img-responsive lazy" alt="<?php echo $product['name'] ?>" />
                                            </a>
                                            <?php } else { ?>
                                    ...
                                    <div class="reviews-wrap">
                                        ...
                                        <?php } else { ?>
                                            <a href="<?php echo $product['href']; ?>">Оставить отзыв</a>
                                        <?php } ?>
                                    </div>
                                    ...
                                    <div class="cart">
                                        <?php if ($product['quantity'] > 0) { ?>
                                            <a class="button-cart btn-green" title="<?php echo $button_cart; ?>" onclick="get_oct_popup_add_to_cart('<?php echo $product['product_id']; ?>', '1');">
                                        ...
                                        <?php } ?>
                                        <a onclick="get_oct_popup_add_to_wishlist('<?php echo $product['product_id']; ?>');" title="<?php echo $button_wishlist; ?>" class="wishlist oct-button">
                                        ...
                                        <a onclick="get_oct_popup_add_to_compare('<?php echo $product['product_id']; ?>');" title="<?php echo $button_compare; ?>" class="compare oct-button">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="buttons clearfix">
                    <div>
                        ...
                        <button onclick="history.back()" class="oct-button"><?php echo $button_continue; ?></button>
                    </div>
                  </div>
