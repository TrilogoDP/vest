...
$_['text_new_greeting']         = 'Ваше замовлення № %s прийнято в обробку, Інтернет-магазин «VEST».';
$_['mf_text_bottom']        	= 'Якщо у Вас є будь-які питання, дайте відповідь на це повідомлення, або зв`яжіться з нами по тел:';
$_['mf_text_social']        	= 'Ми в соціальних мережах:';