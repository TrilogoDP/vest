...
// Heading
$_['heading_title']  = 'Контакти інтернет магазину VEST';
...
$_['meta_description']        = 'Контактна сторінка інтернет-магазину VEST. Магазин Vest - найкраща техніка і електроніка ✅ Аксесуари для електроніки ✅ Низькі ціни на товари ✅ Швидка доставка. Тел. ☎️ %s | Vest';
