...
// Text
$_['text_donotcall']                 = 'Не звоните мне, заказ подтверждаю! Все данные указаны верно.';
$_['text_cart']                      = 'Корзина';
$_['text_checkout_customer']         = 'Покупатель';
$_['text_checkout_customer_login']   = 'Я постоянный покупатель, войти';
$_['text_fill_with']   				 = 'Заполнить данные и войти с';
...
$_['text_agree']                     = 'Согласен с правилами <a class="colorbox fancybox agree" href="%s" alt="%s"><b>%s</b></a>';
...
$_['text_proceed_payment']           = '<i class="fa fa-spinner fa-spin"></i> Подождите немножко, мы оформляем заказ...';
$_['text_checkout_shipping_address'] = 'Адрес доставки';
...
$_['text_if_you_have_questions_call']     = 'Если у вас есть вопросы, звоните по телефонам:';
...
// Error
$_['error_login']                    = 'Ошибка: Неверный Телефон, email или пароль!';
