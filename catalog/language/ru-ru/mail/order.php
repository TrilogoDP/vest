...
$_['text_new_greeting']         = 'Ваш заказ № %s принят в обработку, Интернет-магазин «VEST».';
$_['mf_text_bottom']        	= 'Если у Вас есть какие-либо вопросы, ответьте на это сообщение, или свяжитесь с нами по тел:';
$_['mf_text_social']        	= 'Мы в социальных сетях:';