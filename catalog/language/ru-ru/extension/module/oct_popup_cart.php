...
$_['text_items'] = '<p>В кошику <span>%s %s</span> на суму <span>%s</span></p>';
...
$_['button_addon']           = 'Добавить';

$_['text_related']                            = 'С этим товаром также покупают:';
$_['text_related_havediscount']               = 'Покупай вместе и получи скидку:';
...
$_['error_option_stock'] = 'Извините, но количество опции "%s" для товара "%s" превышает доступное на складе.';