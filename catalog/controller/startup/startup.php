<?php
	class ControllerStartupStartup extends Controller {
		public function index() {
			...
			if ($this->registry->get('isPC') && $this->config->get('config_limit_catalog_pc')){
				$this->config->set($this->config->get('config_theme') . '_product_limit', $this->config->get('config_limit_catalog_pc'));
			}

			if ($this->registry->get('isTablet') && $this->config->get('config_limit_catalog_tablet')){
				$this->config->set($this->config->get('config_theme') . '_product_limit', $this->config->get('config_limit_catalog_tablet'));
			}

			if ($this->registry->get('isMobile') && $this->config->get('config_limit_catalog_mobile')){
				$this->config->set($this->config->get('config_theme') . '_product_limit', $this->config->get('config_limit_catalog_mobile'));
			}
