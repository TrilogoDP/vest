...
class ControllerAccountSimpleaddress extends SimpleController {
    ...
    public function update($args = null) {
        ...
        $this->_templateData['action'] = 'index.php?'.$this->simpleaddress->getAdditionalParams().'route=account/simpleaddress/update&address_id=' . $addressId;
         ...
         if ($this->simpleaddress->getAdditionalParams()){
                 $this->_templateData['action'] = $this->url->link('account/simpleaddress/update&address_id=' . $addressId, $this->simpleaddress->getAdditionalParams());
        } else {
                $this->_templateData['action'] = $this->url->link('account/simpleaddress/update&address_id=' . $addressId);
        }
