	...
	*/
	...
	class ControllerCheckoutSimpleCheckout extends SimpleController {
		...
		public function index($args = null) {
			...
			$this->document->addStyle('catalog/view/theme/oct_techstore/stylesheet/pretty-checkbox.css');
		...
		*/
			...
			$this->_templateData['text_if_you_have_questions_call']     = $this->language->get('text_if_you_have_questions_call');
		...
		private function order() {
			...
			if ($this->customer->isLogged() && $this->model_account_order->canDoNotCall()){
				if ($this->request->server['REQUEST_METHOD'] == 'POST') {
