    ...
    class ControllerOctemplatesBlogArticle extends Controller {
        ...
        public function index() {
            ...
            if ($article_info) {
                ...
                $data['text_look_at_this'] = $this->language->get('text_read_this');
                
                $data['share'] = $this->url->link('octemplates/blog_article', 'oct_blog_article_id=' . $this->request->get['oct_blog_article_id']);
				$data['share_txt'] = $this->language->get('text_read_this') . ' ' . $this->url->link('octemplates/blog_article', 'oct_blog_article_id=' . $this->request->get['oct_blog_article_id']);
				$data['share_txt_with_name'] = $this->language->get('text_read_this') . ' ' . $data['heading_title'];
